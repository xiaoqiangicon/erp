...
var View = Backbone.View.extend({
      ...
      $.ajax({
        ...
        success: function (data) {
          if (window.location.pathname == "/zzhadmin/templeApplyFillInfo/") {
            var name = data.data.name, province = data.data.province, city = data.data.city, address = data.data.address, registrant = data.data.registrant, registrantMobile = data.data.registrantMobile, placeNo = data.data.placeNo, mobile = data.data.mobile, email = data.data.email, corporation = data.data.corporation;
            $("#login").addClass("hide");
            $("#logined").removeClass("hide").text(name);
  ...
  submitFillNext: function (e) {
    var self = this, $tar = $(e.target);
    var name = $("#templeName").val(), placeNo = $("#templeCode").val(), province = $("[data-id=\"province\"]").val(), city = $("[data-id=\"city\"]").val(), address = $("#address").val(), corporation = $("#templeLegal").val(), mobile = $("#templeTel").val(), email = $("#templeEmail").val(), isLegal = $("[name=\"Legal\"]:checked").val(), registrant = $("#templeSignin").val(), registrantMobile = $("#templePhone").val(), templeVertifica = $("#templeVertifica").val(), pwd = $("#templePassword").val();
