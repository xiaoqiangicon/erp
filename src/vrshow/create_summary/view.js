...
$.seeView({
  ...
  onKeyupTextarea: function (e) {
    var $tar = $(e.target), $numTip = $tar.next(), total = parseInt($numTip.html().match(/\/(\d+)/)[1]), number = $tar.val().length;
    if (number) {
  ...
  onClickAddImg: function (e) {
    var upload = new ChooseImage({
      ...
      onSubmit: function (resData) {
        var $container = $("[data-ele=\"img-cell-container\"]"), $imgContainer = $("[data-ele=\"img-container\"]"), $addImg = $("[data-ele=\"add-img\"]"), htmlStr = "";
  ...
  onClickDeleteImg: function (e) {
    var $tar = $(e.target), $deleteImg = $("[data-ele=\"delete-img\"]"), $imgContainer = $("[data-ele=\"img-container\"]"), $addImg = $("[data-ele=\"add-img\"]");
  ...
  onClickDeleteSound: function (e) {
    var $addSoundContainer = $("[data-ele=\"add-sound-container\"]"), $audioContainer = $("[data-ele=\"audio-container\"]"), $audio = $("[data-ele=\"audio\"]");
  ...
  onClickSubmit: function (e) {
    var $scene = $("#scene"), $summary = $("#summary"), $audio = $("[data-ele=\"audio\"]"), sceneId = parseInt($scene.val()), summary = $summary.val(), pic = "", newArr = [], sound = $audio.attr("src");
    data.imgData.map(function (item) {
