...
$.seeView({
  ...
  onClickActionFilter: function (e) {
    var region = parseInt($("#filter-region").val()) || 0, startDate = $("#filter-start-date").val(), endDate = $("#filter-end-date").val(), search = $("#filter-search").val(), searchType = parseInt($("#filter-search-type").val());
    if (startDate && endDate) {
      var startDateNumber = parseInt(startDate.slice(0, 4) + startDate.slice(5, 7) + startDate.slice(8, 10));
      var endDateNumber = parseInt(endDate.slice(0, 4) + endDate.slice(5, 7) + endDate.slice(8, 10));
  ...
  onClickTabType: function (e) {
    ...
    var $region = $("#filter-region"), $startDate = $("#filter-start-date"), $endDate = $("#filter-end-date"), $search = $("#filter-search");
