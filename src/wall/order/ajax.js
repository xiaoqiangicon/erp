...
var preHandleOuter = {
  unhandledOrders: function (req) {
    ...
    req.mobile = "";
    req.contactName = "";
    if (req.searchType === 1) req.mobile = search; else if (req.searchType === 2) req.contactName = search; else req.searchText = search;
...
$.seeAjax.config({
  ...
  url: {
    ...
    unhandledOrders: ["/zzhadmin/buddhaWall_orderList/?filterType=1", "/src/wall/order/mock/unhandled_orders_server.json", "/src/wall/order/mock/unhandled_orders.json"],
    handledOrders: ["/zzhadmin/buddhaWall_orderList/?filterType=2", "/src/wall/order/mock/handled_orders_server.json", "/src/wall/order/mock/handled_orders.json"],
    handle: ["/zzhadmin/buddhaWall_dealOrder/", "/src/wall/order/mock/handle_server.json", "/src/wall/order/mock/handle.json"],
    detail: ["/zzhadmin/buddhaWall_getOrder/", "/src/wall/order/mock/detail_server.json", "/src/wall/order/mock/detail.json"],
    saveMemo: ["/zzhadmin/buddhaWall_editMemo/", "/src/wall/order/mock/save_memo_server.json", "/src/wall/order/mock/save_memo.json"],
    updateFeedImage: ["/zzhadmin/buddhaWall_dealOrder/", "/src/wall/order/mock/update_feed_image_server.json", "/src/wall/order/mock/update_feed_image.json"],
    ...
    savePrinter: ["/zzhadmin/print_appoint_wall_order/", "/src/wall/order/mock/save_printer_server.json", "/src/wall/order/mock/save_printer.json"]
  },
  requestKeys: {
    unhandledOrders: [requestKeysOuter.unhandledOrders, requestKeysOuter.unhandledOrders, {
      regionId: "regionId",
      startDate: "startDate",
      endDate: "endDate",
      search: "search",
    ...
    handledOrders: [requestKeysOuter.handledOrders, requestKeysOuter.handledOrders, {
      regionId: "regionId",
      startDate: "startDate",
      endDate: "endDate",
      search: "search",
    ...
    handle: [requestKeysOuter.handle, requestKeysOuter.handle, {
      id: "id",
      type: "type",
      image: "image"
    }],
    ...
    saveMemo: [requestKeysOuter.saveMemo, requestKeysOuter.saveMemo, {
      id: "id",
      memo: "memo"
    }],
    updateFeedImage: [requestKeysOuter.updateFeedImage, requestKeysOuter.updateFeedImage, {
      id: "id",
      type: "status",
      image: "image"
    }],
    ...
    savePrinter: [requestKeysOuter.savePrinter, requestKeysOuter.savePrinter, {
      ids: "ids",
      printers: "printers",
      printType: "printType",
  ...
  responseRefactor: {
    unhandledOrders: [responseRefactorOuter.unhandledOrders, responseRefactorOuter.unhandledOrders],
    handledOrders: [responseRefactorOuter.handledOrders, responseRefactorOuter.handledOrders],
  ...
  preHandle: {
    unhandledOrders: [preHandleOuter.unhandledOrders, preHandleOuter.unhandledOrders],
  ...
  postHandle: {
    ...
    unhandledOrders: [postHandleOuter.unhandledOrders, postHandleOuter.unhandledOrders],
    handledOrders: [postHandleOuter.handledOrders, postHandleOuter.handledOrders],
