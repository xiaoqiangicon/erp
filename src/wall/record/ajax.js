  ...
  add: function (req) {
    ...
    contactList.map(function (contact) {
      ...
      if (contact.name || contact.phone) {
        ...
        if (contact.lunar && contact.year && contact.month && contact.day || !contact.lunar && contact.birth) {
          text += "|";
          if (!contact.lunar) {
            text += contact.birth + "-0";
          } else {
            var lunarData = LunarCalendar.lunarToSolar(contact.year, contact.month, contact.day);
            text += lunarData.year + "-" + (lunarData.month > 9 ? lunarData.month : "0" + lunarData.month) + "-" + (lunarData.day > 9 ? lunarData.day : "0" + lunarData.day) + "-1";
          }
        }
      }
    ...
    if (contactList) {
      ...
      contactListArray.map(function (item) {
        ...
        if (birthData) {
          ...
          birth = birthDataArray[0] + "-" + birthDataArray[1] + "-" + birthDataArray[2];
          if (lunar) {
            ...
            birth = year + "-" + (month > 9 ? month : "0" + month) + "-" + (day > 9 ? day : "0" + day);
          }
        }
...
$.seeAjax.config({
  ...
  url: {
    ...
    regions: ["/zzhadmin/buddhaWallWallList/", "/src/wall/record/mock/regions_server.json", "/src/wall/record/mock/regions.json"],
    detail: ["/zzhadmin/buddhaWall_seatChart/", "/src/wall/record/mock/detail_server.json", "/src/wall/record/mock/detail.json"],
    cellInfo: ["/zzhadmin/buddhaWall_getRecord/", "/src/wall/record/mock/cell_info_server.json", "/src/wall/record/mock/cell_info.json"],
    onlineCellInfo: ["/zzhadmin/buddhaWall_getOrder/", "/src/wall/record/mock/online_cell_info_server.json", "/src/wall/record/mock/online_cell_info.json"],
    add: ["/zzhadmin/buddhaWall_addrecord/", "/src/wall/record/mock/add_server.json", "/src/wall/record/mock/add.json"],
    edit: ["/zzhadmin/buddhaWall_editrecord/", "/src/wall/record/mock/edit_server.json", "/src/wall/record/mock/edit.json"],
    editOnline: ["/zzhadmin/buddhaWall_editorder/", "/src/wall/record/mock/edit_online_server.json", "/src/wall/record/mock/edit_online.json"]
  },
  requestKeys: {
    detail: [requestKeysOuter.detail, requestKeysOuter.detail, {
      id: "id"
    }],
    cellInfo: [requestKeysOuter.cellInfo, requestKeysOuter.cellInfo, {
      id: "id",
      row: "row",
      column: "column"
    }],
    onlineCellInfo: [requestKeysOuter.onlineCellInfo, requestKeysOuter.onlineCellInfo, {
      id: "id",
      row: "row",
      column: "column"
    }],
    ...
    edit: [requestKeysOuter.edit, requestKeysOuter.edit, {
      id: "id",
      regionId: "regionId",
      row: "row",
      column: "column",
    ...
    editOnline: [requestKeysOuter.edit, requestKeysOuter.edit, {
      id: "id",
      regionId: "regionId",
      row: "row",
      column: "column",
  ...
  responseRefactor: {
    ...
    onlineCellInfo: [responseRefactorOuter.onlineCellInfo, responseRefactorOuter.onlineCellInfo]
  },
  preHandle: {
  ...
  postHandle: {
    ...
    onlineCellInfo: [postHandleOuter.onlineCellInfo, postHandleOuter.onlineCellInfo]
  }
});
