...
$.seeView({
  ...
  onClickActionFilter: function (e) {
    var $region = $("#filter-region"), region = parseInt($region.val()) || 0, $remainDays = $("#filter-remain-days"), remainDays = parseInt($remainDays.val());
  ...
  onClickTabType: function (e) {
    var $this = $(e.currentTarget), type = parseInt($this.attr("data-tab-type"));
    var $region = $("#filter-region"), $remainDays = $("#filter-remain-days");
  ...
  onClickSelectAll: function (e) {
    var $this = $(e.currentTarget), $selects = $("[data-row-select]");
  ...
  onClickRowSend: function (e) {
    var $this = $(e.target), id = parseInt($this.attr("data-row-send")), ids = [id];
    $.seeAjax.post("getSendInfo", {
      type: data.currentTabType,
      ids: ids
    }, function (res) {
