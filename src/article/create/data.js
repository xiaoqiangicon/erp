...
var data = {
  ...
  randomMoney: "5,5,5,5.55,5.88,6,6,6.66,6.68,6.88,7.77,8,8.88,9.66,9.99,10,10,10,10,10.01,10.88,11.11,13.14,13.88,15.68,16,16.66,16.88,18,18.18,18.88,19.19,19.88,20,20,20,20.66,20.66,22,22.22,25.55,26.66,26.88,28,28.88,68,88",
...
data.formatedParams = {
  action: !data.params.action ? "add" : data.params.action == "update" ? "update" : data.params.action == "copy" ? "copy" : "other",
