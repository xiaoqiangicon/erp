...
$.seeAjax.config({
  ...
  url: {
    list: ["/zzhadmin/getArticleSuixiList/", "/src/article/interact/mock/list_server.json", "/src/article/interact/mock/list.json"]
  },
  requestKeys: {
    ...
    download: [requestKeysOuter.download, requestKeysOuter.download, {
      startDate: "startDate",
      endDate: "endDate"
    }]
  },
