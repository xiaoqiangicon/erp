...
!(function(e) {
  ...
  function i(e, t) {
    ...
    return (
      o &&
        e instanceof Array &&
        (E && clearTimeout(E), (E = setTimeout(n, 1e3 * o))),
      D(e, t)
    );
  }
  function n() {
  ...
  function o(e, t, i) {
    if (
      (null == i &&
        (null == t
          ? ((i = e), (e = null))
          : ((i = t), (t = null), e instanceof Array && ((t = e), (e = null)))),
      null != i)
    ) {
      var n = window.opera;
      if (
  ...
  function l(e) {
    ...
    if (t && !m(e, M)) {
      ...
      'function' == typeof n &&
        ...
        !t.depsDec &&
          n
            .toString()
            .replace(/(\/\*([\s\S]*?)\*\/|([^:]|^)\/\/(.*)$)/gm, '')
            .replace(/require\(\s*(['"'])([^'"]+)\1\s*\)/g, function(e, t, n) {
              i.push(n);
            }));
      var o = [],
        r = [];
      C(i, function(i, n) {
        ...
        d && !P[d]
          ? (h.res &&
              ((l = { id: i, mod: d, res: h.res }), r.push(i), t.depRs.push(l)),
            (s = t.depMkv[d]),
            s ||
              ((s = { id: h.mod, absId: d, hard: a > n }),
              t.depMs.push(s),
              (t.depMkv[d] = s),
              o.push(d)))
          : (s = { absId: d }),
  ...
  function d(e) {
    function t(e) {
      ...
      var n = z[e],
        a = !0;
      return (
        C(n.depMs, function(e) {
          return (a = t(e.absId));
        }),
        a &&
          C(n.depRs, function(e) {
            return (a = !!e.absId);
          }),
        a && (n.state = F),
        a
  ...
  function _() {
    ...
    (N.baseUrl = N.baseUrl.replace(/\/$/, '') + '/'),
      ...
      C(N.packages, function(e) {
        var t = e;
        'string' == typeof e &&
          (t = { name: e.split('/')[0], location: e, main: 'main' }),
  ...
  function S(e, t) {
    function i() {
      var e = n.readyState;
      ('undefined' == typeof e || /^(loaded|complete)$/.test(e)) &&
        ((n.onload = n.onreadystatechange = null), (n = null), t());
    }
  ...
  var E,
    ...
    J = 4,
    O = {},
    P = { require: i, exports: 1, module: 1 },
    D = v(),
    N = {
      baseUrl: './',
      paths: {},
  ...
  define('echarts/echarts', [
    ...
    (s.version = '2.2.7'),
      (s.dependencies = { zrender: '2.1.1' }),
      (s.init = function(t, n) {
        var a = e('zrender');
        a.version.replace('.', '') - 0 <
          s.dependencies.zrender.replace('.', '') - 0 &&
          console.error(
            'ZRender ' +
              a.version +
      ...
      (i.prototype = {
        _init: function() {
          ...
          for (var n in a.EVENT)
            'CLICK' != n &&
              ...
              'MOUSEOUT' != n &&
              'MAP_ROAM' != n &&
              this._messageCenter.bind(a.EVENT[n], this._onevent, this);
          var o = {};
          ...
          u.define('title', e('./component/title')),
            ...
            (0 === i.getWidth() || 0 === i.getHeight()) &&
              console.error(
                'Dom鈥檚 width & height should be ready before init.'
              );
        },
          ...
          switch (
            ...
            case a.EVENT.MAGIC_TYPE_CHANGED:
              if (!t) {
                ...
                n &&
                  (n.silence(!0), n.setMagicType(e.magicType), n.silence(!1));
              }
        ...
        _ondblclick: function(e) {
          if ((n(this, 'ondblclick', e), e.target)) {
            ...
            t &&
              null != t.seriesIndex &&
              this._messageCenter.dispatch(a.EVENT.DBLCLICK, e.event, t, this);
          }
        },
        ...
        _onmouseout: function(e) {
          if (e.target) {
            ...
            t &&
              null != t.seriesIndex &&
              this._messageCenter.dispatch(a.EVENT.MOUSEOUT, e.event, t, this);
          }
        },
        ...
        _ondragend: function(e) {
          if (
            (n(this, 'ondragend', e, this._status),
        ...
        _eventPackage: function(t) {
          if (t) {
            ...
            return (
              (a =
                -1 != n && this.component.dataZoom
                  ? this.component.dataZoom.getRealDataIndex(n, a)
                  : a),
              {
                seriesIndex: n,
        ...
        _noDataCheck: function(e) {
          for (var t = e.series, i = 0, n = t.length; n > i; i++)
            if (
              t[i].type == a.CHART_TYPE_MAP ||
              (t[i].data && t[i].data.length > 0) ||
              (t[i].markPoint &&
                t[i].markPoint.data &&
                t[i].markPoint.data.length > 0) ||
              (t[i].markLine &&
                t[i].markLine.data &&
                t[i].markLine.data.length > 0) ||
              (t[i].nodes && t[i].nodes.length > 0) ||
              (t[i].links && t[i].links.length > 0) ||
              (t[i].matrix && t[i].matrix.length > 0) ||
              (t[i].eventList && t[i].eventList.length > 0)
            )
              return !1;
          ...
          if ((this._mergeGlobalConifg(t), !this._noDataCheck(t))) {
            ...
            if (i)
              if (l || -1 == i.indexOf('rgba'))
                ...
                (this.dom.style.filter =
                  'alpha(opacity=' +
                  100 * n[3].substring(0, n[3].lastIndexOf(')')) +
                  ')'),
                  (n.length = 3),
                  (n[0] = n[0].replace('a', '')),
            ...
            for (
              ...
              (h = c[m]),
                ...
                t[h]
                  ? (d
                      ? d.refresh && d.refresh(t)
                      : ((s = r.get(/^[xy]Axis$/.test(h) ? 'axis' : h)),
                        (d = new s(
                          this._themeConfig,
                          this._messageCenter,
                          this._zr,
                  ...
                  ? g[V] ||
                    ...
                    u
                      ? (this.chart[V]
                        ...
                        (this.chart[V] = U))
                      : console.error(V + ' has not been required.'))
                  : console.error(
                      'series[' + m + '] chart type has not been defined.'
                    );
            for (V in this.chart)
              V == a.CHART_TYPE_ISLAND ||
                g[V] ||
                (this.chart[V].dispose(),
                (this.chart[V] = null),
                delete this.chart[V]);
            this.component.grid &&
        ...
        _setOption: function(e, t, i) {
          return (
            !t && this._option
              ? (this._option = o.merge(this.getOption(), o.clone(e), !0))
              : ((this._option = o.clone(e)),
        ...
        addData: function(e, t, i, n, r) {
          function s() {
            if (c._zr) {
              ...
              for (var e = 0, t = w.length; t > e; e++)
                w[e].motionlessOnce =
                  h.addDataAnimation && w[e].addDataAnimation;
          ...
          for (
            var l = e instanceof Array ? e : [[e, t, i, n, r]],
              h = this.getOption(),
              ...
              if ((g[V](t), f[V](t), n || (g[U](), (t = f[U]())), null != r)) {
                ...
                if (
                  ...
                  var k,
                    v,
                    L = u.xAxisIndex || 0;
                  (null == d.xAxis[L].type || 'category' === d.xAxis[L].type) &&
                    ((k = d.xAxis[L].data),
                    (v = h.xAxis[L].data),
                    k[V](r),
                    v[V](r),
          ...
          for (
            ...
            h.addDataAnimation &&
              w[m].addDataAnimation &&
              (W++, w[m].addDataAnimation(l, X));
          return (
          ...
          if (a && (n = a[e])) {
            ...
            for (var d in t)
              'data' === d
                ...
                : 'object' != typeof t[d] || null == l[d]
                ? (l[d] = h[d] = t[d])
                : (o.merge(l[d], t[d], !0), o.merge(h[d], t[d], !0));
        ...
        getConnectedDataURL: function(t) {
          ...
          for (var l in n)
            d.addShape(
              new c({
                style: { x: n[l].left - a, y: n[l].top - o, image: n[l].img },
              })
            );
          d.render();
        ...
        getConnectedImage: function(e) {
          var t = this._optionRestore.title,
            i = document.createElement('img');
          return (
            (i.src = this.getConnectedDataURL(e)),
            (i.title = (t && t.text) || 'ECharts'),
            i
          );
        },
        ...
        showLoading: function(t) {
          ...
          t.textStyle = n;
          var r = o.merge(
            o.merge(o.clone(n), this._themeConfig.textStyle),
            a.textStyle
          );
          (n.textFont =
            r.fontStyle +
        ...
        resize: function() {
          ...
          return function() {
            ...
            return (
              e.component.grid && e.component.grid.refixAxisShape(e.component),
              e._zr.refresh(),
  ...
  define('zrender/tool/util', ['require', '../dep/excanvas'], function(e) {
    ...
    function n(e, i, n, o) {
      if (i.hasOwnProperty(n)) {
        var r = e[n];
        'object' != typeof r || g[f.call(r)] || t(r)
          ? (!o && n in e) || (e[n] = i[n])
          : a(e[n], i[n], o);
      }
    }
  ...
  define('zrender/tool/env', [], function() {
    function e(e) {
      ...
      return (
        ...
        s &&
          !r &&
          ((t.ios = t.iphone = !0), (t.version = s[2].replace(/_/g, '.'))),
  ...
  define('zrender/zrender', [
    ...
    return (
      ...
      (c.prototype.addElement = function(e) {
        return (
          this.storage.addRoot(e), (this._needsRefreshNextFrame = !0), this
        );
      }),
      (c.prototype.delElement = function(e) {
        return (
          this.storage.delRoot(e), (this._needsRefreshNextFrame = !0), this
        );
      }),
      ...
      (c.prototype.modLayer = function(e, t) {
        return (
          this.painter.modLayer(e, t), (this._needsRefreshNextFrame = !0), this
        );
      }),
    ...
    return (
      (t.prototype = {
        ...
        ondragend: function(e, t) {
          var i = e.target;
          this.isDragend
            ? t.dragIn && (this.del(i), (t.needRefresh = !0))
            : t.dragIn ||
              ((i.style.x = s.getX(e.event)),
      ...
      (t.prototype = {
        ...
        _buildShape: function() {
          ...
          for (var n in t)
            if (t[n].show)
              switch (n) {
                case 'mark':
                  i.push({ key: n, name: 'mark' }),
                    i.push({ key: n, name: 'markUndo' }),
                    i.push({ key: n, name: 'markClear' });
                  break;
                case 'magicType':
                  for (var a = 0, o = t[n].type.length; o > a; a++)
                    (t[n].title[t[n].type[a] + 'Chart'] =
                      t[n].title[t[n].type[a]]),
                      t[n].option &&
                        (t[n].option[t[n].type[a] + 'Chart'] =
                          t[n].option[t[n].type[a]]),
                      i.push({ key: n, name: t[n].type[a] + 'Chart' });
                  break;
                case 'dataZoom':
                  i.push({ key: n, name: 'dataZoom' }),
                    i.push({ key: n, name: 'dataZoomReset' });
                  break;
                case 'saveAsImage':
                  this.canvasSupported &&
                    i.push({ key: n, name: 'saveAsImage' });
                  break;
                default:
                  i.push({ key: n, name: n });
              }
          if (i.length > 0) {
            for (var r, n, a = 0, o = i.length; o > a; a++)
              (r = i[a].name),
                ...
                t[n].color &&
                  (this._featureColor[r] = t[n].color[r] || t[n].color),
                t[n].option &&
                  (this._featureOption[r] = t[n].option[r] || t[n].option);
            ...
            switch (
              ((t = {
                ...
                style: {
                  ...
                  lineWidth: 1,
                  strokeColor:
                    this._featureColor[this._iconList[U]] || p[U % p.length],
                  brushType: 'stroke',
                },
                highlightStyle: {
                  lineWidth: 1,
                  text: s.showTitle
                    ? this._featureTitle[this._iconList[U]]
                    : void 0,
                  textFont: u,
                  textPosition: i,
                  strokeColor:
              ...
              this._featureIcon[this._iconList[U]] &&
                ((t.style.image = this._featureIcon[this._iconList[U]].replace(
                  new RegExp('^image:\\/\\/'),
                  ''
                )),
                (t.style.opacity = 0.8),
              ...
              case 'saveAsImage':
                ...
                break;
              default:
                this._iconList[U].match('Chart')
                  ? ((t._name = this._iconList[U].replace('Chart', '')),
                    (t.onclick = V._onMagicType))
                  : (t.onclick = V._onCustomHandler);
            }
            'icon' === t.type
              ? (t = new r(t))
              : 'image' === t.type && (t = new a(t)),
        ...
        __onMark: function(e) {
          ...
          if (this._marking || this._markStart)
            ...
            setTimeout(function() {
              i.zr &&
                i.zr.on(h.EVENT.CLICK, i._onclick) &&
            ...
            this._markStart &&
              ...
              this._iconShapeMap.mark &&
                this.zr.modShape(this._iconShapeMap.mark.id, {
                  style: {
                    strokeColor: this._iconShapeMap.mark.highlightStyle
                      .strokeColor,
                  },
                }),
        ...
        __onSaveAsImage: function() {
          ...
          i = this.myChart.isConnected()
            ? this.myChart.getConnectedDataURL(t)
            : this.zr.toDataURL(
                'image/' + t,
        ...
        reset: function(e, t) {
                ...
                this._magicMap[a] &&
                  ((o =
                    e.xAxis instanceof Array
                      ? e.xAxis[e.series[n].xAxisIndex || 0]
                      : e.xAxis),
                  o &&
                  ...
                  (o =
                    e.yAxis instanceof Array
                      ? e.yAxis[e.series[n].yAxisIndex || 0]
                      : e.yAxis),
                  o &&
                    'category' === o.type &&
                    (o.__boundaryGap =
                      null != o.boundaryGap ? o.boundaryGap : !0),
                  (e.series[n].__type = a),
                  (e.series[n].__itemStyle = l.clone(
                    e.series[n].itemStyle || {}
                  ))),
                (this._magicMap[c] || this._magicMap[m]) &&
          ...
          if (s && s.show) {
            var h =
                null != s.start && s.start >= 0 && s.start <= 100 ? s.start : 0,
              d = null != s.end && s.end >= 0 && s.end <= 100 ? s.end : 100;
            h > d && ((h += d), (d = h - d), (h -= d)),
              (this._zoomQueue = [{ start: h, end: d, start2: 0, end2: 100 }]);
        ...
        getMagicOption: function() {
          ...
          if (
            ...
            for (
              var i = this._magicType[s.CHART_TYPE_LINE] ? !1 : !0,
                n = 0,
                ...
                (t == s.CHART_TYPE_LINE || t == s.CHART_TYPE_BAR) &&
                  ((e =
                    this.option.xAxis instanceof Array
                      ? this.option.xAxis[this.option.series[n].xAxisIndex || 0]
                      : this.option.xAxis),
                  e &&
                    'category' === (e.type || 'category') &&
                    (e.boundaryGap = i ? !0 : e.__boundaryGap),
                  (e =
                    this.option.yAxis instanceof Array
                      ? this.option.yAxis[this.option.series[n].yAxisIndex || 0]
                      : this.option.yAxis),
                  e &&
                    'category' === e.type &&
                    (e.boundaryGap = i ? !0 : e.__boundaryGap));
          ...
          if (
            ...
            for (var n = 0, a = this.option.series.length; a > n; n++)
              this._magicType[c]
                ? ((this.option.series[n].stack = '_ECHARTS_STACK_KENER_2014_'),
                  (t = c))
                : this._magicType[m] &&
                  ((this.option.series[n].stack = null), (t = m)),
        ...
        _defaultMagic: function(e, t) {
          if (this._magicType[e] || this._magicType[t])
            for (var i = 0, n = this.option.series.length; n > i; i++) {
              ...
              (a == e || a == t) &&
                ((this.option.series[i].type = this._magicType[e] ? e : t),
                (this.option.series[i].itemStyle = l.clone(
      ...
      (t.prototype = {
        ...
        _getItemGroupLocation: function() {
          var e,
            ...
            l =
              s.getTextHeight(i, a) +
              ('' === n ? 0 : this.titleOption.itemGap + s.getTextHeight(n, o)),
            h = this.zr.getWidth();
      ...
      (t.prototype = {
        ...
        _style: function(e) {
          ...
          n &&
            ...
            n.fontSize &&
              t.push('line-height:' + Math.round((3 * n.fontSize) / 2) + 'px'),
        ...
        _show: function(e, t, i, n) {
          ...
          e &&
            ('function' == typeof e && (e = e([t, i])),
            e instanceof Array && ((t = e[0]), (i = e[1]))),
        ...
        __tryShow: function() {
          ...
          if (this._curTarget) {
            ...
            (e = this.deepQuery([n, i, this.option], 'tooltip.show')),
              null != i && null != n && e
                ? ((t = this.deepQuery([n, i, this.option], 'tooltip.trigger')),
                  'axis' === t
        ...
        _findAxisTrigger: function() {
          ...
          for (
            var e, t, i = this.option.series, n = 0, a = i.length;
            a > n;
            n++
          )
            if (
              'axis' === this.deepQuery([i[n], this.option], 'tooltip.trigger')
            )
              return (
                (e = i[n].xAxisIndex || 0),
                (t = i[n].yAxisIndex || 0),
                ...
                this.component.xAxis.getAxis(e).type ===
                  s.COMPONENT_TYPE_AXIS_CATEGORY
        ...
        _getNearestDataIndex: function(e, t) {
          ...
          if ('x' === e) {
            for (
              ...
              (o = l), (l = t.getCoordByIndex(++i));
            return (
              0 >= i
                ? (i = 0)
                : r - n >= n - o
                ? (i -= 1)
                : null == t.getNameByIndex(i) && (i -= 1),
              i
            );
          }
          for (
            var h, c, m = this.component.grid.getY(), l = t.getCoordByIndex(i);
            l > m && ((h = l), l >= a);

          )
            (c = l), (l = t.getCoordByIndex(++i));
          return (
            0 >= i
              ? (i = 0)
              : a - h >= c - a
        ...
        _showAxisTrigger: function(e, t, i) {
          ...
          if (V) {
            ...
            for (var g = 0, f = l.length; f > g; g++)
              this._isSelected(l[g].name) &&
                l[g][V + 'Index'] === U &&
                'axis' ===
                  this.deepQuery([l[g], this.option], 'tooltip.trigger') &&
                ((r = this.query(l[g], 'tooltip.showContent') || r),
                (a = this.query(l[g], 'tooltip.formatter') || a),
                (o = this.query(l[g], 'tooltip.position') || o),
                (m += this._style(this.query(l[g], 'tooltip'))),
                null != l[g].stack && 'xAxis' == V
                  ? (h.unshift(l[g]), c.unshift(g))
                  : (h.push(l[g]), c.push(g)));
            this.messageCenter.dispatch(
              s.EVENT.TOOLTIP_HOVER,
              this._event,
            ...
            if (
              ...
              if ('function' == typeof a) {
                ...
                for (var g = 0, f = h.length; f > g; g++)
                  (a = a.replace(
                    '{a' + g + '}',
                    this._encodeHTML(h[g].name || '')
                  )),
                    (a = a.replace(
                      '{b' + g + '}',
                      this._encodeHTML(n.getNameByIndex(i))
                    )),
                    (b = h[g].data[i]),
                    (b = this.getDataFromOption(b, '-')),
                    (a = a.replace(
                      '{c' + g + '}',
                      b instanceof Array ? b : this.numAddCommas(b)
                    ));
        ...
        _showPolarTrigger: function(e, t) {
          ...
          for (
            var h = this.option.polar[e].indicator[t].text, c = 0, m = o.length;
            m > c;
            c++
          )
            this._isSelected(o[c].name) &&
              o[c].polarIndex === e &&
              'axis' ===
                this.deepQuery([o[c], this.option], 'tooltip.trigger') &&
              ((a = this.query(o[c], 'tooltip.showContent') || a),
          ...
          if (r.length > 0) {
            for (var p, u, V, U = [], c = 0, m = r.length; m > c; c++) {
              ...
              for (var g = 0, f = p.length; f > g; g++)
                (u = p[g]),
                  this._isSelected(u.name) &&
                    ((u =
                      null != u ? u : { name: '', value: { dataIndex: '-' } }),
            ...
            if (
              ...
              if (
                ...
                for (var c = 0, m = U.length; m > c; c++)
                  (i = i.replace(
                    '{a' + c + '}',
                    this._encodeHTML(U[c].seriesName)
                  )),
                    (i = i.replace(
                      '{b' + c + '}',
                    ...
                    (i = i.replace(
                      '{c' + c + '}',
                      this.numAddCommas(U[c].value)
                    )),
                    (i = i.replace(
                      '{d' + c + '}',
                      this._encodeHTML(U[c].indicator)
                    ));
        ...
        _showItemTrigger: function(e) {
          if (this._curTarget) {
            ...
            if ('island' != this._curTarget._type) {
              var g = e ? 'axis' : 'item';
              this.option.tooltip.trigger === g &&
                ((t = this.option.tooltip.formatter),
                (i = this.option.tooltip.position)),
                this.query(a, 'tooltip.trigger') === g &&
                  ((n = this.query(a, 'tooltip.showContent') || n),
                ...
                'function' == typeof t
                  ...
                  : ((this._curTicket = 0 / 0),
                    (this._tDom.innerHTML =
                      a.type === s.CHART_TYPE_RADAR && p
                        ? this._itemFormatter.radar.call(this, a, c, m, p)
                        : a.type === s.CHART_TYPE_EVENTRIVER
                        ? this._itemFormatter.eventRiver.call(this, a, c, m, r)
                        : '' +
                          (null != a.name
            ...
            this.deepQuery(V, 'tooltip.axisPointer.show') && this.component.grid
              ? this._styleAxisPointer(
                  [a],
                  this.component.grid.getX(),
                  y,
        ...
        _itemFormatter: {
          radar: function(e, t, i, n) {
            ...
            for (var o = 0; o < n.length; o++)
              a +=
                this._encodeHTML(n[o].text) +
                ' : ' +
                this.numAddCommas(i[o]) +
                '<br />';
            return a;
          },
            ...
            for (var o = 0, r = n.length; r > o; o++)
              (a += '<div style="padding-top:5px;">'),
                n[o].detail &&
                  ...
                  (a +=
                    '<div style="margin-left:45px;">' + n[o].time + '<br/>'),
          ...
          if (e.length > 0) {
            ...
            for (var u = 0, V = e.length; V > u; u++)
              (l = e[u]),
                ...
                h &&
                  ((m[h].color =
                    this.query(l, 'tooltip.axisPointer.' + h + 'Style.color') ||
                    m[h].color),
                  (m[h].width =
                    this.query(l, 'tooltip.axisPointer.' + h + 'Style.width') ||
                    m[h].width),
                  (m[h].type =
                    this.query(l, 'tooltip.axisPointer.' + h + 'Style.type') ||
                    m[h].type));
            if ('line' === c) {
              var U = m.line.width,
                g = t == n;
          ...
          if (
            ...
            if (t) {
              ...
              if (
                ...
                -1 != (a = this.component.polar.isInside([i, n]))
              )
                for (
              ...
              (this._curTarget = !1),
                ...
                this._needAxisTrigger &&
                this.component.grid &&
                c.isInside(r, this.component.grid.getArea(), i, n)
                  ...
                  : this._needAxisTrigger &&
                    this.component.polar &&
                    -1 != this.component.polar.isInside([i, n])
                  ? (this._showingTicket = setTimeout(
                      this._tryShow,
                      this._showDelay
                    ))
        ...
        ontooltipHover: function(e, t) {
          if (
            !this._lastTipShape ||
            (this._lastTipShape && this._lastTipShape.dataIndex != e.dataIndex)
          ) {
            this._lastTipShape &&
              this._lastTipShape.tipShape.length > 0 &&
              (this.zr.delShape(this._lastTipShape.tipShape),
            ...
            for (var i = 0, n = t.length; n > i; i++)
              (t[i].zlevel = this.getZlevelBase()),
                (t[i].z = this.getZBase()),
                (t[i].style = u.prototype.getHighlightStyle(
                  t[i].style,
                  t[i].highlightStyle
                )),
                (t[i].draggable = !1),
                ...
                if (c) {
                  ...
                  switch (d.type) {
                      ...
                      for (var f = e.name, a = 0, o = g.length; o > a; a++)
                        if (
                          ...
                          var y = this._curTarget.style,
                            b =
                              (((y.startAngle + y.endAngle) / 2) * Math.PI) /
                              180;
                          (V =
                    ...
                    case s.CHART_TYPE_MAP:
                      for (
                        var f = e.name, _ = r.mapType, a = 0, o = g.length;
                        o > a;
                        a++
                      )
                        if (
                  ...
                  null != V &&
                    null != U &&
                    ((this._event = { zrenderX: V, zrenderY: U }),
        ...
        refresh: function(e) {
          if (
            ...
            (this._showDelay = this.option.tooltip.showDelay),
              ...
              !this._enterable &&
                this._tDom.className.indexOf(h.elementClassName) < 0 &&
                (this._tDom.className += ' ' + h.elementClassName);
          }
          if (this.showing) {
            var a = this;
            setTimeout(function() {
    ...
    t.prototype = {
      ...
      _buildItem: function() {
        ...
        'vertical' === this.legendOption.orient &&
          ...
          (g = this._itemGroupLocation.x + this._itemGroupLocation.width - y);
        for (var x = 0; p > x; x++)
          (o = h.merge(m[x].textStyle || {}, u)),
            ...
            '' !== e
              ? ((t = m[x].icon || this._getSomethingByName(e).type),
                (c = this.getColor(e)),
                'horizontal' === this.legendOption.orient
                  ? 200 > V - g &&
                    y +
                      ...
                      (x === p - 1 || '' === m[x + 1] ? 0 : _) >=
                      V - g &&
                    ((g = this._itemGroupLocation.x), (f += b + _))
                  : 200 > U - f &&
                    b + (x === p - 1 || '' === m[x + 1] ? 0 : _) >= U - f &&
                    ('right' === this.legendOption.x
                      ? (g -= this._itemGroupLocation.maxWidth + _)
                      : (g += this._itemGroupLocation.maxWidth + _),
                    (f = this._itemGroupLocation.y)),
                (i = this._getItemShapeByType(
                  ...
                  y,
                  b,
                  this._selectedMap[e] && this._hasDataMap[e] ? c : '#ccc',
                  t,
                  c
                )),
                (i._name = e),
                ...
                'vertical' === this.legendOption.orient &&
                  'right' === this.legendOption.x &&
                  ((a.style.x -= y + 10), (a.style.textAlign = 'right')),
                (a._name = e),
                (a = new n(a)),
                this.legendOption.selectedMode &&
                  ((i.onclick = a.onclick = this._legendSelected),
        ...
        if ('horizontal' === this.legendOption.orient) {
          ...
          for (var U = 0; t > U; U++)
            if ('' !== this._getName(e[U])) {
              ...
              u + n + g + i > m
                ? ((u -= i), (s = Math.max(s, u)), (l += a + i), (u = 0))
                : ((u += n + g + i), (s = Math.max(s, u - i)));
          ...
          for (var U = 0; t > U; U++)
            '' !== this._getName(e[U])
              ? u + a + i > p
                ? ((s += V + i), (u -= i), (l = Math.max(l, u)), (u = 0))
                : ((u += a + i), (l = Math.max(l, u - i)))
              : ((s += V + i), (u -= i), (l = Math.max(l, u)), (u = 0));
        }
      ...
      _getSomethingByName: function(e) {
        for (var t, i = this.option.series, n = 0, a = i.length; a > n; n++) {
          ...
          if (
            i[n].type === l.CHART_TYPE_PIE ||
            i[n].type === l.CHART_TYPE_RADAR ||
            i[n].type === l.CHART_TYPE_CHORD ||
            i[n].type === l.CHART_TYPE_FORCE ||
            i[n].type === l.CHART_TYPE_FUNNEL ||
            i[n].type === l.CHART_TYPE_TREEMAP
          ) {
          ...
          case 'k':
            (d.style.brushType = 'both'),
              ...
              (d.highlightStyle.color = d.style.color =
                this.deepQuery([this.ecTheme, l], 'k.itemStyle.normal.color') ||
                '#fff'),
              (d.style.strokeColor =
                '#ccc' != a
                  ? this.deepQuery(
      ...
      refresh: function(e) {
        if (e) {
          ...
          for (var s = 0, h = o.length; h > s; s++)
            (t = this._getName(o[s])),
              '' !== t &&
                ((i = this._getSomethingByName(t)),
                i.series
                  ? ((this._hasDataMap[t] = !0),
                    (a =
                      !i.data ||
                      (i.type !== l.CHART_TYPE_PIE &&
                        i.type !== l.CHART_TYPE_FORCE &&
                        i.type !== l.CHART_TYPE_FUNNEL)
                        ? [i.series]
                        : [i.data, i.series]),
                    (n = this.getItemStyleColor(
                    ...
                    (this._selectedMap[t] =
                      null != this._selectedMap[t] ? this._selectedMap[t] : !0))
      ...
      getRelatedAmount: function(e) {
        for (
          var t, i = 0, n = this.option.series, a = 0, o = n.length;
          o > a;
          a++
        )
          if (
            (n[a].name === e && i++,
            n[a].type === l.CHART_TYPE_PIE ||
              n[a].type === l.CHART_TYPE_RADAR ||
              n[a].type === l.CHART_TYPE_CHORD ||
              n[a].type === l.CHART_TYPE_FORCE ||
              n[a].type === l.CHART_TYPE_FUNNEL)
          ) {
      ...
      getItemShape: function(e) {
        if (null != e)
          for (var t, i = 0, n = this.shapeList.length; n > i; i++)
            if (((t = this.shapeList[i]), t._name === e && 'text' != t.type))
              return t;
      },
    ...
    var c = {
      ...
      radar: function(e, t) {
        ...
        for (var d = 0, c = i - 1; c > d; d++)
          e.lineTo(n + o * Math.cos(s), a + o * Math.sin(s)), (s += r);
        e.lineTo(l, h);
      },
    };
  ...
  define('echarts/util/ecData', [], function() {
    function e(e, t, i, n, a, o, r, s) {
      var l;
      return (
        'undefined' != typeof n && (l = null == n.value ? n : n.value),
        (e._echartsData = {
          _series: t,
          _seriesIndex: i,
          _data: n,
  ...
  define('zrender/tool/color', ['require', '../tool/util'], function(e) {
    ...
    function s(e, t, i, n, a, o, r) {
      O || (O = P.getContext());
      for (
        var s = O.createRadialGradient(e, t, i, n, a, o), l = 0, h = r.length;
        h > l;
        l++
      )
    ...
    function l(e, t, i, n, a) {
      O || (O = P.getContext());
      for (
        var o = O.createLinearGradient(e, t, i, n), r = 0, s = a.length;
        s > r;
        r++
      )
    ...
    function h(e, t, i) {
      ...
      for (
        ...
        (n[l] = c(
          [
            T(Math.floor(h), [0, 255]),
            T(Math.floor(d), [0, 255]),
            T(Math.floor(m), [0, 255]),
            p.toFixed(4) - 0,
          ],
          'rgba'
        )),
    ...
    function p(e, t) {
      ...
      return (
        ...
        e.indexOf('hsb') > -1
          ? (i = z(i))
          : e.indexOf('hsl') > -1 && (i = A(i)),
        t.indexOf('hsb') > -1 || t.indexOf('hsv') > -1
          ? (i = F(i))
          : t.indexOf('hsl') > -1 && (i = J(i)),
        (i[3] = n),
        c(i, t)
      );
    }
    ...
    function X(e, t, i) {
      if (!E(e) || !E(t)) return e;
      'undefined' == typeof i && (i = 0.5), (i = 1 - T(i, [0, 1]));
      for (
        var n = 2 * i - 1,
          a = S(u(e)),
          o = S(u(t)),
    ...
    function S(e) {
      ...
      if (t[2])
        ...
        (n = r[3]),
          ...
          (o = C(a, function(e) {
            return (
              (e = Math.floor(e.indexOf('%') > 0 ? 2.55 * parseInt(e, 0) : e)),
              T(e, [0, 255])
            );
          })),
        ...
        (r._setCurrentOption = function() {
          ...
          r.myChart._setOption(t, e.notMerge, !0),
            r.messageCenter.dispatch(
              s.EVENT.TIMELINE_CHANGED,
              null,
              {
                currentIndex: r.currentIndex,
                data:
                  null != e.data[r.currentIndex].name
                    ? e.data[r.currentIndex].name
                    : e.data[r.currentIndex],
              },
              r.myChart
            );
        }),
    ...
    function i(e, t) {
      ...
      if ('last' === l)
        ...
        (d = l.replace(new RegExp('^image:\\/\\/'), '')),
          ...
          l(e, { x: n, y: a, width: r, height: s, image: d });
      }
    }
    var n = e('./base'),
      a = e('zrender/shape/Rectangle'),
      ...
      (t.prototype = {
        ...
        _buildShape: function() {
          if (
            ...
            for (
              var e = this._getInterval(), t = 0, i = this._chainPoint.length;
              i > t;
              t += e
            )
        ...
        _getLocation: function() {
          ...
          null == t.width
            ? ((e = n - a - o), (o = n - o))
            : ((e = this.parsePercent(t.width, n)), (o = a + e));
          var r,
            s,
            l = this.zr.getHeight(),
          ...
          return (
            null != t.y
              ? ((r = this.parsePercent(t.y, l)), (s = r + h))
              : ((s = l - this.parsePercent(t.y2, l)), (r = s - h)),
            {
              x: a + i[3],
              y: r + i[0],
              x2: o - i[1],
        ...
        _getReformedLabel: function(e) {
          ...
          return (
            n &&
              ('function' == typeof n
                ? (i = n.call(this.myChart, i))
                : 'string' == typeof n && (i = n.replace('{value}', i))),
            i
          );
        },
        ...
        _getChainPoint: function() {
            ...
            if (
              ...
              for (var U = 1; p > U; U++)
                u[U] =
                  d +
                  V +
                  (m * (new Date(e(U).replace(/-/g, '/')) - u[0])) / u[p - 1];
              u[0] = d + V;
            }
          } else u.push(d + m / 2);
          for (var g, f, y, b, _, x = [], U = 0; p > U; U++)
            (d = u[U]),
              ...
              g.match('empty')
                ? ((g = g.replace('empty', '')), (y = !0))
                : (y = !1),
              g.match('star') &&
                ((f = g.replace('star', '') - 0 || 5), (g = 'star')),
              (t = h[U].textStyle ? l.merge(h[U].textStyle || {}, r) : r),
              (b = t.align || 'center'),
              o
                ? ((b = o > 0 ? 'right' : 'left'),
                  (_ = [(o * Math.PI) / 180, d, c - 5]))
                : (_ = !1),
              x.push({
                x: d,
                n: f,
        ...
        _buildControl: function() {
          ...
          if ('none' !== t.controlPosition) {
            ...
            'left' === t.controlPosition
              ? ((a = this._location.x), (this._location.x += 3 * (r + s)))
              : ((a = this._location.x2 - (3 * (r + s) - s)),
        ...
        _findChainIndex: function(e) {
          ...
          for (var n = 0; i - 1 > n; n++)
            if (e >= t[n].x && e <= t[n + 1].x)
              return Math.abs(e - t[n].x) < Math.abs(e - t[n + 1].x)
                ? n
                : n + 1;
        },
        __onclick: function(e) {
        ...
        __ondrift: function(e, t) {
          ...
          var i,
            n = this._chainPoint,
            a = n.length;
          e.style.x + t <= n[0].x - n[0].symbolSize
            ? ((e.style.x = n[0].x - n[0].symbolSize), (i = 0))
            : e.style.x + t >= n[a - 1].x - n[a - 1].symbolSize
            ? ((e.style.x = n[a - 1].x - n[a - 1].symbolSize), (i = a - 1))
            : ((e.style.x += t), (i = this._findChainIndex(e.style.x)));
          var o = n[i],
            r = o.symbolSize + 2;
          if (
  ...
  define('zrender/shape/Image', ['require', './Base', '../tool/util'], function(
    e
  ) {
    var t = e('./Base'),
      i = function(e) {
      ...
      (i.prototype = {
        ...
        brush: function(e, t, i) {
          ...
          var a = n.image,
            o = this;
          if (
            (this._imageCache || (this._imageCache = {}), 'string' == typeof a)
          ) {
            var r = a;
            this._imageCache[r]
              ? (a = this._imageCache[r])
              : ((a = new Image()),
                (a.onload = function() {
    ...
    return (
      ...
      (t.prototype._start = function(e, t) {
        var i = n.merge(this.options, {
          ...
          l = i.effectOption,
          h = new o({ highlightStyle: n.clone(l) });
        return (
          (h.highlightStyle.color =
            l.color ||
            a.getLinearGradient(l.x, l.y, l.x + l.width, l.y + l.height, [
              [0, '#ff6400'],
              [0.5, '#ffe100'],
              [1, '#b1ff00'],
            ])),
          null != i.progress
            ? (e(s),
              (h.highlightStyle.width =
                this.adjust(i.progress, [0, 1]) * i.effectOption.width),
              e(h),
              e(r),
              void t())
            : ((h.highlightStyle.width = 0),
              setInterval(function() {
                e(s),
                  h.highlightStyle.width < l.width
                    ? (h.highlightStyle.width += 8)
                    : (h.highlightStyle.width = 0),
                  e(h),
                  e(r),
                  t();
      ...
      (t.prototype._start = function(e, t) {
        ...
        return setInterval(function() {
          ...
          for (var i = 0; h > i; i++) {
            ...
            n.y - m[i].animationY + n.r <= 0 &&
              ((m[i].highlightStyle.y = u + n.r),
  ...
  define('zrender/loadingEffect/Ring', [
    ...
    return (
      ...
      (t.prototype._start = function(e, t) {
        ...
        for (
          var h = this.createTextShape(i.textStyle),
            ...
            V = s.color,
            U = a.lift(V, 0.1),
            g = new o({ highlightStyle: n.clone(s) }),
            f = [],
            y = a.getGradientColors(['#ff6400', '#ffe100', '#97ff00'], 25),
            b = 15,
            _ = 240,
            x = 0;
          16 > x;
        ...
        if (null != i.progress) {
          e(d),
            ...
            e(g);
          for (var x = 0; 20 > x; x++)
            (f[x].highlightStyle.color = k > x ? f[x]._color : U), e(f[x]);
          return e(h), void t();
        }
        return setInterval(function() {
          e(d), (k += k >= 20 ? -20 : 1), e(g);
          for (var i = 0; 20 > i; i++)
            (f[i].highlightStyle.color = k > i ? f[i]._color : U), e(f[i]);
          e(h), t();
        }, s.timeInterval);
      }),
      t
    ...
    return (
      ...
      (t.prototype._start = function(e, t) {
        ...
        var u = this.createBackgroundShape(i.backgroundColor),
          ...
          f = [0, m.x, m.y];
        return (
          (V.highlightStyle.x = U.highlightStyle.x = g.highlightStyle.x = f[1]),
          (V.highlightStyle.y = U.highlightStyle.y = g.highlightStyle.y = f[2]),
          setInterval(function() {
            e(u), e(g), (f[0] -= 0.3), (V.rotation = f), e(V), e(U), e(l), t();
          }, m.timeInterval)
        );
      }),
      t
    ...
    return (
      document.createElement('canvas').getContext
        ...
        : !(function() {
            ...
            function a(e) {
              if (
                (n(e, 'g_vml_', 'urn:schemas-microsoft-com:vml'),
              ...
              if (a instanceof W) {
                ...
                for (
                  var L = k.length,
                    w = k[0].color,
                    I = k[L - 1].color,
                    S = k[0].alpha * e.globalAlpha,
                    K = k[L - 1].alpha * e.globalAlpha,
                    T = [],
                    E = 0;
                  L > E;
                  E++
            ...
            var P = {
              ...
              init_: function(e) {
                for (
                  var t = e.getElementsByTagName('canvas'), i = 0;
                  i < t.length;
                  i++
                )
              ...
              initElement: function(t) {
                if (!t.getContext) {
                  ...
                  i.width && i.width.specified
                    ? (t.style.width = i.width.nodeValue + 'px')
                    : (t.width = t.clientWidth),
                    i.height && i.height.specified
                      ? (t.style.height = i.height.nodeValue + 'px')
            ...
            (Q.clearRect = function() {
              ...
              (Q.stroke = function(e) {
                ...
                for (
                  var a = { x: null, y: null }, o = { x: null, y: null }, r = 0;
                  r < this.currentPath_.length;
                  r++
                ) {
                  var s,
                    l = this.currentPath_[r];
                  switch (l.type) {
                    case 'moveTo':
                    ...
                    case 'wa':
                      t.push(
                        ...
                        l.type,
                        ' ',
                        T(l.x - this.scaleX_ * l.radius),
                        ',',
                        T(l.y - this.scaleY_ * l.radius),
                        ' ',
                        T(l.x + this.scaleX_ * l.radius),
                        ',',
                        T(l.y + this.scaleY_ * l.radius),
              ...
              (Q.restore = function() {
                this.aStack_.length &&
                  (h(this.aStack_.pop(), this), (this.m_ = this.mStack_.pop()));
              }),
              ...
              (Q.measureText = function(e) {
                ...
                return (
                  this.textMeasureEl_.appendChild(i.createTextNode(e)),
  ...
  define('zrender/mixin/Eventful', ['require'], function() {
    ...
    return (
      (e.prototype.one = function(e, t, i) {
        var n = this._handlers;
        return t && e
          ? (n[e] || (n[e] = []),
            n[e].push({ h: t, one: !0, ctx: i || this }),
            this)
          : this;
      }),
      ...
      (e.prototype.dispatchWithContext = function(e) {
        if (this._handlers[e]) {
          ...
          for (
            var n = t[t.length - 1], a = this._handlers[e], o = a.length, r = 0;
            o > r;
  ...
  define('zrender/Handler', [
      ...
      V = {
        ...
        click: function(e, t) {
          if (u(e) || t) {
            ...
            ((i && i.clickable) || !i) &&
              ...
              this._dispatchAgency(i, c.CLICK, e),
        ...
        dblclick: function(e, t) {
          if (u(e) || t) {
            ...
            ((i && i.clickable) || !i) &&
              this._clickThreshold < 5 &&
              this._dispatchAgency(i, c.DBLCLICK, e),
              this._mousemoveHandler(e);
          }
        },
        ...
        mousemove: function(e, t) {
          if ((u(e) || t) && !this.painter.isLoading()) {
            ...
            (this._hasfound && this._lastHover.draggable)
              ? (a = 'move')
              : this._hasfound && this._lastHover.clickable && (a = 'pointer'),
    ...
    (U.prototype.on = function(e, t, i) {
      ...
      (U.prototype._processDragEnd = function(e) {
        this._draggingTarget &&
          (this._dispatchAgency(this._draggingTarget, c.DRAGEND, e),
          (this._lastHover = null)),
          (this._isDragging = 0),
      ...
      (U.prototype._dispatchAgency = function(e, t, i, n) {
        var a = 'on' + t,
          o = { type: t, event: i, target: e, cancelBubble: !1 },
          r = e;
        for (
          n && (o.dragged = n);
          r &&
          (r[a] && (o.cancelBubble = r[a](o)),
          r.dispatch(t, o),
          (r = r.parent),
          !o.cancelBubble);
          ...
          for (
            ...
            if (
              (t !== r.zlevel &&
                ...
                (a[1] = this._mouseY),
                i.needTransform &&
                  (d.invert(e, i.transform), h.applyTransform(a, a, e))),
    ...
    return (
      (U.prototype._mobileFindFixed = function(e) {
        (this._lastHover = null),
  ...
  define('zrender/Painter', [
    ...
    return (
        ...
        for (var s = 0, l = e.length; l > s; s++) {
          ...
          if (
            (n !== h.zlevel &&
              ...
              (i = this.getLayer(n)),
              i.isBuildin ||
                r('ZLevel ' + n + ' has been used by unkown layer ' + i.id),
              (o = i.ctx),
              (i.unusedCount = 0),
              (i.dirty || t) && i.clear(),
              i.needTransform && (o.save(), i.setTransform(o))),
            (i.dirty || t) &&
              !h.invisible &&
      ...
      (h.prototype.insertLayer = function(e, t) {
        ...
        s.nextSibling
          ? s.parentNode.insertBefore(t.dom, s.nextSibling)
          : s.parentNode.appendChild(t.dom),
          (this._layers[e] = t);
      }),
      ...
      (h.prototype.refreshHover = function() {
        this.clearHover();
        for (
          var e = this.storage.getHoverShapes(!0), t = 0, i = e.length;
          i > t;
          t++
        )
      ...
      (h.prototype._brushHover = function(e) {
        ...
        if (!e.onbrush || (e.onbrush && !e.onbrush(t, !0))) {
          ...
          if (
            (i.needTransform && (t.save(), i.setTransform(t)),
      ...
      (h.prototype._shapeToImage = function(t, i, n, a, o) {
        ...
        (i.position = [0, 0, 0]),
          ...
          i && i.brush(s, !1);
        var h = e('./shape/Image'),
          d = new h({ id: t, style: { x: 0, y: 0, image: r } });
        return (
          null != l.position && (d.position = i.position = l.position),
  ...
  define('zrender/Storage', ['require', './tool/util', './Group'], function(e) {
    ...
    return (
        ...
        for (var i = [], n = 0, a = this._hoverElements.length; a > n; n++) {
          ...
          if (o) {
            ...
            for (var s = 0, l = o.length; l > s; s++)
              (r = o[s].id ? o[s] : this.get(o[s])), r && i.push(r);
          }
        }
        if ((i.sort(t), e))
        ...
        if (!e.ignore)
          if (
            ...
            e.clipShape &&
              ...
              t ? ((t = t.slice()), t.push(e.clipShape)) : (t = [e.clipShape])),
            'group' == e.type)
          ) {
      ...
      (o.prototype.mod = function(e, t) {
        if (
          ('string' == typeof e && (e = this._elements[e]),
          e && (e.modSelf(), t))
        )
      ...
      (o.prototype.drift = function(e, t, i) {
        ...
        return (
          n &&
            ((n.needTransform = !0),
            'horizontal' === n.draggable
              ? (i = 0)
              : 'vertical' === n.draggable && (t = 0),
      ...
      (o.prototype.addRoot = function(e) {
        this._elements[e.id] ||
          (e instanceof n && e.addChildrenToStorage(this),
          this.addToMap(e),
          this._roots.push(e));
      }),
      ...
      (o.prototype.addToMap = function(e) {
        return (
          e instanceof n && (e._storage = this),
          e.modSelf(),
      ...
      (o.prototype.delFromMap = function(e) {
        ...
        return (
          t &&
            (delete this._elements[e], t instanceof n && (t._storage = null)),
          this
        );
      }),
  ...
  define('zrender/animation/Animation', [
    ...
    function s(e, t, i, n, a, o, r) {
      var s = 0.5 * (i - e),
        l = 0.5 * (n - t);
      return (
        (2 * (t - i) + s + l) * r + (-3 * (t - i) - 2 * s - l) * o + s * a + t
      );
    }
    function l(e) {
      if (o(e)) {
    ...
    (U.prototype = {
      ...
      _update: function() {
        ...
        for (var r = 0; n > r; )
          i[r].__needsRemove ? ((i[r] = i[n - 1]), i.pop(), n--) : r++;
        n = a.length;
              ...
              if (U) {
                ...
                if (U) {
                  ...
                  for (var x = [], k = [], v = 0; U > v; v++) {
                    ...
                    'string' == typeof L &&
                      ((L = c.toArray(L)),
                      0 === L.length && ((L[0] = L[1] = L[2] = 0), (L[3] = 1)),
                      (y = !0)),
                      k.push(L);
                  }
                  var w,
                      ...
                      if (0 !== d) {
                        if (((W = (o - x[v]) / d), m))
                          if (
                            ...
                            var c;
                            y
                              ? ((c = r(X, I, S, K, W, W * W, W * W * W, E, 1)),
                                (c = h(E)))
                              : (c = s(X, I, S, K, W, W * W, W * W * W)),
                              i(e, V, c);
                          }
  ...
  define('zrender/Layer', [
    ...
    return (
      (s.prototype.initContext = function() {
      ...
      (s.prototype.resize = function(e, t) {
        ...
        (this.dom.style.width = e + 'px'),
          ...
          this.domBack &&
            (this.domBack.setAttribute('width', e * i),
    ...
    return (
      (n.prototype = {
        ...
        brush: function(e, i) {
          var n = this.style;
          if (
            (i && (n = this.getHighlightStyle(n, this.highlightStyle || {})),
            ...
            var a,
              o = (n.text + '').split('\n'),
              r = t.getTextHeight('鍥�', n.textFont),
              s = this.getRect(n),
              l = n.x;
            a =
              'top' == n.textBaseline
                ? s.y
                : 'bottom' == n.textBaseline
                ? s.y + r
                : s.y + r / 2;
          ...
          return (
            (o =
              'top' == e.textBaseline
                ...
                ? e.y - n
                : e.y - n / 2),
            (e.__rect = { x: a, y: o, width: i, height: n }),
            e.__rect
          );
        },
      }),
  ...
  define('zrender/tool/area', ['require', './util', './curve'], function(e) {
    ...
    function n(e, t, i, n) {
      ...
      switch (a) {
        case 'bezier-curve':
          return 'undefined' == typeof t.cpX2
            ? l(
                t.xStart,
                t.yStart,
                t.cpX1,
        ...
        case 'path':
          return (
            t.pathArray &&
            _(t.pathArray, Math.max(t.lineWidth, 5), t.brushType, i, n)
          );
        case 'polygon':
        case 'star':
        case 'isogon':
    ...
    function a(e, t, i, n, a) {
      return (
        t.beginPath(), e.buildPath(t, i), t.closePath(), t.isPointInPath(n, a)
      );
    }
    function o(e, t, n, a) {
      return !i(e, t, n, a);
    ...
    function s(e, t, i, n, a, o, r, s, l, h, d) {
      ...
      var c = Math.max(l, 5);
      if (
        (d > t + c && d > n + c && d > o + c && d > s + c) ||
        (t - c > d && n - c > d && o - c > d && s - c > d) ||
        (h > e + c && h > i + c && h > a + c && h > r + c) ||
        (e - c > h && i - c > h && a - c > h && r - c > h)
      )
        return !1;
    ...
    function b(e, i, n, a, o, r, s, l) {
      ...
      for (var c = 0, m = 0; 2 > m; m++) {
        ...
        if (p + e > s) {
          ...
          0 > u && (u = C + u),
            ((u >= a && o >= u) || (u + C >= a && o >= u + C)) &&
              (u > Math.PI / 2 && u < 1.5 * Math.PI && (d = -d), (c += d));
        }
      }
      return c;
    }
  ...
  define('zrender/shape/Base', [
    ...
    function t(t, n, a, o, r, s, l) {
      ...
      for (var c = 0, m = n.length; m > c; c++)
        t.fillText(n[c], a, o), (o += d);
    }
    function i(t, i, n, a, o, r) {
      var s = e('../tool/area'),
        l = s.getTextWidth(t, a),
        h = s.getTextHeight('鍥�', a);
      switch (((t = (t + '').split('\n')), o)) {
        case 'end':
        case 'right':
          i -= l;
    ...
    return (
      ...
      (d.prototype.getHighlightStyle = function(t, i, n) {
        ...
        'stroke' != t.brushType
          ...
          ? ((a.strokeColor = s),
            (a.lineWidth = (t.lineWidth || 1) + this.getHighlightZoom()))
          : (a.strokeColor = i.strokeColor || r.mix(t.strokeColor, r.toRGB(s)));
      ...
      (d.prototype.isCover = function(t, i) {
        ...
        return (
          (t = n[0]),
          (i = n[1]),
          this.isCoverRect(t, i)
            ? e('../tool/area').isInside(this, this.style, t, i)
            : !1
        );
      }),
          ...
          switch (d) {
            ...
            case 'end':
              ...
              0 > V - u ? (f += 180) : 0 > U - g && (f += 360),
                (h = 5),
                f >= 30 && 150 >= f
                  ? ((o = 'center'), (r = 'bottom'), (l -= h))
                  : f > 150 && 210 > f
                  ? ((o = 'right'), (r = 'middle'), (s -= h))
                  : f >= 210 && 330 >= f
                  ? ((o = 'center'), (r = 'top'), (l += h))
                  : ((o = 'left'), (r = 'middle'), (s += h));
              break;
    ...
    function l(e, t, i, a, o, r, s, l, h, d, c) {
      ...
      for (var x = 0; 32 > x && !(U > p); x++) {
        ...
        if (k >= 0 && u > f) (m = k), (u = f);
          ...
          1 >= v && u > L ? ((m = v), (u = L)) : (p *= 0.5);
        }
      }
      return (
        c && ((c[0] = n(e, i, o, s, m)), (c[1] = n(t, a, r, l, m))),
        Math.sqrt(u)
      );
    }
    function h(e, t, i, n) {
    ...
    function u(e, t, i, n, a, o, r, s, l) {
      ...
      for (var g = 0; 32 > g && !(U > c); g++) {
        ...
        if (f >= 0 && m > u) (d = f), (m = u);
          ...
          1 >= x && m > k ? ((d = x), (m = k)) : (c *= 0.5);
        }
      }
      return (
        l && ((l[0] = h(e, i, a, d)), (l[1] = h(t, n, o, d))), Math.sqrt(m)
      );
    }
    var V = e('./vector'),
      U = 1e-4,
    ...
    return (
      (l.prototype = {
        ...
        updateTransform: function() {
          ...
          if (
            ((this.needTransform = this.needLocalTransform || e),
            this.needTransform)
          ) {
            ...
            e &&
              (this.needLocalTransform
                ? n.mul(t, this.parent.transform, t)
                : n.copy(t, this.parent.transform)),
              (this.transform = t),
        ...
        transformCoordToLocal: function(e, t) {
          ...
          return (
            this.needTransform &&
              this.invTransform &&
              a.applyTransform(i, i, this.invTransform),
            i
          );
        },
      }),
        ...
        (this.shapeHandler = {
          ...
          ondragover: function(e) {
            ...
            (i.brushType = 'stroke'),
              ...
              setTimeout(function() {
                i &&
                  ((i.brushType = n), (i.strokeColor = a), (i.lineWidth = r));
              }, 20);
          },
          ondrop: function(e) {
    ...
    return (
      (i.prototype = {
        setCalculable: function(e) {
          return (
            (e.dragEnableTime =
              this.ecTheme.DRAG_ENABLE_TIME || h.DRAG_ENABLE_TIME),
            ...
            if (-1 === r) {
              ...
              (i = s[o].data[r] || '-'),
                null != i.value
                  ? ((s[o].data[r].value =
                      '-' != i.value
                        ? p.accAdd(s[o].data[r].value, d.get(a, 'value'))
                        : d.get(a, 'value')),
                    (this.type === h.CHART_TYPE_FUNNEL ||
                      this.type === h.CHART_TYPE_PIE) &&
                      (l &&
                        1 === l.getRelatedAmount(i.name) &&
                        this.component.legend.del(i.name),
                      (i.name += this.option.nameConnector + d.get(a, 'name')),
                      l && l.add(i.name, a.style.color || a.style.strokeColor)))
                  : (s[o].data[r] =
                      '-' != i
                        ? p.accAdd(s[o].data[r], d.get(a, 'value'))
                        : d.get(a, 'value'));
        ...
        _buildPosition: function() {
          ...
          for (
            ...
            a[r].type === this.type &&
              ...
              i.type === h.COMPONENT_TYPE_AXIS_CATEGORY
                ? o[i.getPosition()].push(r)
                : n.type === h.COMPONENT_TYPE_AXIS_CATEGORY
        ...
        _mapData: function(e) {
          for (
            ...
            if (
              ...
              if (
                ((this.selectedMap[n] = d.isSelected(n)),
        ...
        _calculMarkMapXY: function(e, t, i) {
          for (var n = this.series, a = 0, o = t.length; o > a; a++)
            for (var r = 0, s = t[a].length; s > r; r++) {
              ...
              if ('-1' != i.indexOf('x')) {
                c['counter' + h] > 0 &&
                  (c['average' + h] = c['sum' + h] / c['counter' + h]);
                var m = this.component.xAxis
                  .getAxis(n[l].xAxisIndex || 0)
                  .getCoord(c['average' + h]);
        ...
        _getLabelText: function(e, t, i, n) {
          ...
          a ||
            'emphasis' !== n ||
            (a = this.deepQuery([t, e], 'itemStyle.normal.label.formatter'));
        ...
        _buildMarkPoint: function(e) {
          for (
            ...
            (t = o.data[r]),
              ...
              !t.type ||
                ...
                (t.symbolSize =
                  t.symbolSize ||
                  g.getTextWidth(i[3], this.getFont()) / 2 + 5));
          ...
          if (
            this.type === h.CHART_TYPE_FORCE ||
            this.type === h.CHART_TYPE_CHORD
          )
        ...
        _buildMarkLine: function(e) {
          for (
            ...
            var s = a.data[o];
            !s.type ||
            ('max' !== s.type && 'min' !== s.type && 'average' !== s.type)
              ? (t = [this.getMarkCoord(e, s[0]), this.getMarkCoord(e, s[1])])
              : ((t = this.getMarkCoord(e, s)),
                (a.data[o] = [U.clone(s), {}]),
              ...
              null != t &&
                null != t[0] &&
                null != t[1] &&
                ((a.data[o][0].x = null != s[0].x ? s[0].x : t[0][0]),
        ...
        _markPoint: function(e, t) {
          var i = this.series[e],
            n = this.component;
          U.merge(
            U.merge(t, U.clone(this.ecTheme.markPoint || {})),
            U.clone(h.markPoint)
          ),
            (t.name = i.name);
          var a,
              ...
              null != u[b].x &&
                ...
                (V &&
                  ...
                  (a = this.getSymbolShape(
                    ...
                    b,
                    u[b].name,
                    this.parsePercent(u[b].x, f),
                    this.parsePercent(u[b].y, y),
                    'pin',
                    o,
                    'rgba(0,0,0,0)',
                    'horizontal'
                  ...
                  m.show && (a.effect = m),
                  i.type === h.CHART_TYPE_MAP &&
                    (a._geo = this.getMarkGeo(u[b])),
        ...
        _markLine: (function() {
          ...
          return function(i, n) {
            var a = this.series[i],
              ...
              s = o.legend;
            U.merge(
              U.merge(n, U.clone(this.ecTheme.markLine || {})),
              U.clone(h.markLine)
            );
            ...
            for (
              ...
              if (t(f[0]) && t(f[1])) {
                ...
                (f[0].tooltip = y.tooltip || n.tooltip || { trigger: 'item' }),
                  (f[0].name = f[0].name || ''),
                  (f[1].name = f[1].name || ''),
                  (f[0].value = x),
                  m.push({
                    points: [
                      [
                        this.parsePercent(f[0].x, p),
                        this.parsePercent(f[0].y, u),
                      ],
                      [
                        this.parsePercent(f[1].x, p),
                        this.parsePercent(f[1].y, u),
                      ],
                    ],
                    rawData: f,
                    color: _,
            ...
            if (L) {
              var w = new V();
              (w.maxTurningAngle =
                (this.query(n, 'bundling.maxTurningAngle') / 180) * Math.PI),
                (m = w.run(m));
            }
            n.name = a.name;
            for (var W = [], g = 0, X = m.length; X > g; g++) {
              ...
              C.show && ((K.effect = C), (K.effect.large = n.large)),
                a.type === h.CHART_TYPE_MAP &&
                  (K._geo = [this.getMarkGeo(f[0]), this.getMarkGeo(f[1])]),
                d.pack(
                  K,
                  a,
                  i,
        ...
        getSymbolShape: function(e, t, i, o, r, s, l, h, c, m, p) {
          ...
          return (
            h.match('image') &&
              ((w.style.image = h.replace(new RegExp('^image:\\/\\/'), '')),
              (w = new n({
                style: w.style,
            ...
            h.match('star') &&
              ((w.style.iconType = 'star'),
              (w.style.n =
                h.replace('empty', '').replace('star', '') - 0 || 5)),
            'none' === h && ((w.invisible = !0), (w.hoverable = !1)),
            (w = this.addLabel(w, e, i, r, p)),
            h.match('empty') &&
              (null == w.style.textColor &&
                (w.style.textColor = w.style.strokeColor),
              null == w.highlightStyle.textColor &&
                (w.highlightStyle.textColor = w.highlightStyle.strokeColor)),
            d.pack(w, e, t, i, o, r),
            (w._x = s),
            (w._y = l),
            (w._dataIndex = o),
        ...
        getMarkLineShape: function(e, t, i, n, a, r, l) {
          var h = null != i[0].value ? i[0].value : '-',
            ...
            m = [
              i[0].symbolSize || e.symbolSize[0],
              i[1].symbolSize || e.symbolSize[1],
            ];
          (m[0] = 'function' == typeof m[0] ? m[0](h) : m[0]),
            (m[1] = 'function' == typeof m[1] ? m[1](d) : m[1]);
          var p = [
              this.query(i[0], 'symbolRotate') || e.symbolRotate[0],
              this.query(i[1], 'symbolRotate') || e.symbolRotate[1],
            ],
            u = [i[0], i[1], e],
          ...
          var x = r ? s : o,
            k = new x({
              style: {
                ...
                lineType: g.type,
                shadowColor:
                  g.shadowColor || g.color || V.borderColor || V.color || l,
              ...
              highlightStyle: {
                ...
                lineWidth: b,
                symbolBorderColor:
                  U.borderColor || V.borderColor || U.color || V.color || l,
                symbolBorder:
                  null == U.borderWidth ? V.borderWidth + 2 : U.borderWidth,
              },
              clickable: this.deepQuery(u, 'clickable'),
            }),
            v = k.style;
        ...
        getLargeMarkPointShape: function(e, t) {
          var i,
            ...
            u = [c[0], t];
          if (
            (p && (n = p.getColor(h.name)),
            !m ||
              ((a = null != c[0].value ? c[0].value : ''),
        ...
        addShapeList: function() {
          var e,
            t,
            i = this.option.animationThreshold / (this.canvasSupported ? 2 : 4),
          ...
          if (
            ...
            for (t in d)
              l[t]
                ? (this.zr.delShape(l[t].id),
                  this._animateMod(l[t], d[t], r, s, 0, o))
                : ((e =
                    (this.type != h.CHART_TYPE_LINE &&
                      this.type != h.CHART_TYPE_RADAR) ||
                    0 === t.indexOf('icon')
                      ? 0
                      : r / 2),
        ...
        _getAnimationKey: function(e) {
          return this.type != h.CHART_TYPE_MAP &&
            this.type != h.CHART_TYPE_TREEMAP &&
            this.type != h.CHART_TYPE_VENN &&
            this.type != h.CHART_TYPE_TREE
            ? d.get(e, 'seriesIndex') +
                '_' +
                d.get(e, 'dataIndex') +
                (e._mark ? e._mark : '') +
                (this.type === h.CHART_TYPE_RADAR ? d.get(e, 'special') : '')
            : d.get(e, 'seriesIndex') +
                '_' +
                d.get(e, 'dataIndex') +
        ...
        _animateMod: function(e, t, i, n, a, o) {
          switch (t.type) {
            ...
            case 'circle':
              o
                ? 'sector' === t.type
                  ? c.sector(this.zr, e, t, i, n)
                  : this.zr.addShape(t)
                : c.ring(
                    this.zr,
                    e,
                    t,
                    i + ((d.get(t, 'dataIndex') || 0) % 20) * 100,
                    n
                  );
              break;
            case 'text':
          ...
          if (
            ...
            this.canvasSupported &&
              this.zr.modLayer(t, {
                motionBlur: !0,
                lastFrameAlpha:
                  this.option.effectBlendAlpha || h.effectBlendAlpha,
              });
            for (var i, n = 0, a = e.length; a > n; n++)
              (i = e[n]),
                i._mark &&
                  ...
                  i.effect.show &&
                  m[i._mark] &&
                  (m[i._mark](this.zr, this.effectList, i, t),
        ...
        clearEffectShape: function(e) {
          ...
          if (this.zr && t && t.length > 0) {
            e && this.zr.modLayer(h.EFFECT_ZLEVEL, { motionBlur: !1 }),
              this.zr.delShape(t);
        ...
        delMark: function(e, t, i) {
          ...
          if (this.selectedMap[n.name]) {
            for (
              var a = !1, o = [this.shapeList, this.effectList], r = 2;
              r--;
  ...
  define('echarts/util/accMath', [], function() {
    function e(e, t) {
      ...
      return (
        ((i.replace('.', '') - 0) / (n.replace('.', '') - 0)) * Math.pow(10, a)
      );
    }
    function t(e, t) {
      var i = e.toString(),
      ...
      (X.prototype = {
        ...
        buildPath: function(e, t, i) {
          this.iconLibrary[t.iconType]
            ? this.iconLibrary[t.iconType].call(this, e, t, i)
            : (e.moveTo(t.x, t.y),
              e.lineTo(t.x + t.width, t.y),
              e.lineTo(t.x + t.width, t.y + t.height),
              e.lineTo(t.x, t.y + t.height),
          ...
          return (
            ...
            this.isCoverRect(e, t)
              ? this.style.curveness > 0
                ? l.isInside(s, this.style, e, t)
                : l.isInside(o, this.style, e, t)
              : !1
          );
        },
      }),
        ...
        buildPath: function(e, t) {
          ...
          if (!(n.length < 2)) {
            ...
            if (t.smooth && 'spline' !== t.smooth) {
              ...
              ('spline' === t.smooth && ((n = i(n)), (o = n.length)),
    ...
    return (
      (i.prototype = {
        ...
        getRect: function(e) {
          if (e.__rect) return e.__rect;
          for (
            var t = 1 / 0, i = -(1 / 0), n = 1 / 0, a = -(1 / 0), o = 0;
            o < e.shapeList.length;
            o++
          )
            var r = e.shapeList[o],
              s = r.getRect(r.style),
          ...
          return (
            (e.__rect = { x: t, y: n, width: i - t, height: a - n }), e.__rect
          );
        },
        isCover: function(e, t) {
          var i = this.transformCoordToLocal(e, t);
  ...
  define('echarts/util/ecAnimation', [
    ...
    function t(e, t, i, n, a) {
      ...
      if (!t) {
        ...
        'half-smooth-polygon' == i.type &&
          ((o[s - 1] = u.clone(r[s - 1])), (o[s - 2] = u.clone(r[s - 2]))),
          (t = { style: { pointList: o } });
      }
      o = t.style.pointList;
      var c = o.length;
      (i.style.pointList =
        c == s ? o : s > c ? o.concat(r.slice(c)) : o.slice(0, s)),
        e.addShape(i),
        (i.__animating = !0),
        e
          .animate(i.id, 'style')
    ...
    function n(e, t, n, a, o) {
      ...
      i(n, t, 'x', 'y', 'width', 'height'),
        ...
        e.addShape(n),
        (c[0] != t.position[0] || c[1] != t.position[1]) &&
          e
            .animate(n.id, '')
            .when(a, { position: c })
            .start(o),
        ...
        e
          .animate(n.id, 'style')
          .when(a, { x: s, y: l, width: h, height: d })
          .done(function() {
            n.__animating = !1;
          })
          .start(o);
    ...
    function r(e, t, n, a, o) {
      ...
      i(n, t, 'startAngle', 'endAngle'),
        ...
        e
          .animate(n.id, 'style')
          .when(a, { startAngle: r, endAngle: s })
          .done(function() {
            n.__animating = !1;
          })
          .start(o);
    ...
    function h(e, t, n, a, o) {
      ...
      t.style && i(n, t, 'source0', 'source1', 'target0', 'target1'),
        ...
        e
          .animate(n.id, 'style')
          .when(a, { source0: r, source1: s, target0: l, target1: h })
          .done(function() {
            n.__animating = !1;
          })
          .start(o);
    ...
    function m(e, t, n, a, o) {
      ...
      i(n, t, 'xStart', 'xEnd', 'yStart', 'yEnd'),
        ...
        e
          .animate(n.id, 'style')
          .when(a, { xStart: r, xEnd: s, yStart: l, yEnd: h })
          .done(function() {
            n.__animating = !1;
          })
          .start(o);
    ...
    function p(e, t, i, n, a) {
      ...
      if (o.curveness > 0) {
        ...
        e.animate(i.id, 'style')
          .when(0, { xEnd: s, yEnd: l })
          .when(n, { xEnd: h, yEnd: d })
          .done(r)
          .start(a);
    }
  ...
  define('echarts/util/ecEffect', [
    ...
    function t(e, t, i, n) {
      ...
      'image' !== i.type
        ? ((a = new h({
          ...
          'pin' == i.style.iconType &&
            (a.style.y += (a.style.height / 2) * 1.5),
          u &&
            ((a.style.image = e.shapeToImage(
              a,
              a.style.width + 2 * p + 2,
              a.style.height + 2 * p + 2
            ).style.image),
            (a = new s({
              zlevel: a.zlevel,
              style: a.style,
      ...
      'scale' === r.type
        ? (e.modShape(a.id, { scale: [0.1, 0.1, f, y] }),
          e
            .animate(a.id, '', r.loop)
            .when(g, { scale: [1, 1, f, y] })
            .done(function() {
              (i.effect.show = !1), e.delShape(a.id);
            })
            .start())
        : e
            .animate(a.id, 'style', r.loop)
            .when(g, { y: a.style.y - m })
            .when(2 * g, { y: a.style.y })
            .done(function() {
              (i.effect.show = !1), e.delShape(a.id);
            })
            .start();
    ...
    function i(e, t, i, n) {
      ...
      for (
        var m = Math.round(100 * a.period), p = {}, u = {}, V = 0;
        20 > V;
        V++
      )
    ...
    function n(e, t, i, n, a) {
      ...
      if (i instanceof m) {
        for (
          var b = [0], _ = 0, x = h.pointList, k = h.controlPointList, v = 1;
          v < x.length;
          v++
        ) {
          if (k) {
        ...
        for (
          var W = { p: 0 }, X = e.animation.animate(W, { loop: s.loop }), v = 0;
          v < b.length;
          v++
        )
          X.when(b[v] * s.period, { p: v });
        X.during(function() {
          var t,
            i,
            n = Math.floor(W.p);
          if (n == x.length - 1) (t = x[n][0]), (i = x[n][1]);
            ...
            if (k) {
              ...
              (t = (s[0] - r[0]) * o + r[0]), (i = (s[1] - r[1]) * o + r[1]);
          }
        ...
        if (i.style.curveness > 0) {
          var z = h.cpX1 - f,
            A = h.cpY1 - f;
          g.effectAnimator = e.animation
            .animate(g, { loop: s.loop })
            .when(E, { p: 1 })
            .during(function(t, i) {
    ...
    function a(e, t, i, a) {
      var o = new c({ style: { shapeList: [] }, zlevel: a, hoverable: !1 }),
        r = i.style.shapeList,
        s = i.effect;
      ...
      (s._onlegendhoverlink = function(e) {
        if (s.legendHoverLink)
          for (var t, a = e.target, o = s.shapeList.length - 1; o >= 0; o--)
            (t =
              s.type == i.CHART_TYPE_PIE || s.type == i.CHART_TYPE_FUNNEL
                ? n.get(s.shapeList[o], 'name')
                : (n.get(s.shapeList[o], 'series') || {}).name),
              t != a ||
                s.shapeList[o].invisible ||
                s.shapeList[o].__animating ||
                s.zr.addHoverShape(s.shapeList[o]);
      }),
    ...
    return (
      (t.prototype = {
        ...
        _getZ: function(e) {
          ...
          return t && null != t[e]
            ? t[e]
            : ((t = i[this.type]), t && null != t[e] ? t[e] : 0);
        },
        ...
        reformOption: function(e) {
          return (
            (e = r.merge(
              r.merge(e || {}, r.clone(this.ecTheme[this.type] || {})),
              r.clone(i[this.type] || {})
            )),
            (this.z = e.z),
  ...
  define('echarts/layout/EdgeBundling', [
    ...
    function n(e) {
      var t = e.points;
      t[0][1] < t[1][1] || e instanceof i
        ? ((this.array = [t[0][0], t[0][1], t[1][0], t[1][1]]),
          (this._startPoint = t[0]),
          (this._endPoint = t[1]))
        : ((this.array = [t[1][0], t[1][1], t[0][0], t[0][1]]),
                ...
                if (r.edgeList[0] && r.edgeList[0].edge instanceof i) {
                  ...
                  for (var l = 0; l < r.edgeList.length; l++) {
                    ...
                    (a = t ? t.slice() : []),
                      ...
                      d.push({ points: n(a, h.edge.points), rawEdge: h.edge });
                  }
              }
            };
          return c(a.groups), d;
              ...
              for (var b = 0, _ = null, x = null, k = 0; k < p.length; k++) {
                ...
                v.group
                  ? v.group !== x &&
                    ...
                    (L = v.group.ink + d.ink - U))
                  : ((U = this._calculateEdgeEdgeInk(d, v, u, V)),
                    (L = v.ink + d.ink - U)),
  ...
  define('zrender/shape/util/PathProxy', [
    ...
    return (
      (n.prototype.fastBoundingRect = function() {
        var e = this._min,
          i = this._max;
      ...
      (n.prototype.moveTo = function(e, t) {
        return (
          this.pathCommands.push(new i('M', [e, t])),
      ...
      (n.prototype.lineTo = function(e, t) {
        return (
          this.pathCommands.push(new i('L', [e, t])),
      ...
      (n.prototype.bezierCurveTo = function(e, t, n, a, o, r) {
        return (
          this.pathCommands.push(new i('C', [e, t, n, a, o, r])),
      ...
      (n.prototype.quadraticCurveTo = function(e, t, n, a) {
        return (
          this.pathCommands.push(new i('Q', [e, t, n, a])),
        ...
        buildPath: function(e, t) {
          e.moveTo(t.xStart, t.yStart),
            'undefined' != typeof t.cpX2 && 'undefined' != typeof t.cpY2
              ? e.bezierCurveTo(t.cpX1, t.cpY1, t.cpX2, t.cpY2, t.xEnd, t.yEnd)
              : e.quadraticCurveTo(t.cpX1, t.cpY1, t.xEnd, t.yEnd);
        },
        getRect: function(e) {
          if (e.__rect) return e.__rect;
  ...
  define('zrender/shape/util/dashedLineTo', [], function() {
    ...
    return function(t, i, n, a, o, r) {
      ...
      for (var d = !0, c = 0; h > c; ++c)
        d ? t.moveTo(i, n) : t.lineTo(i, n), (d = !d), (i += s), (n += l);
      t.lineTo(a, o);
    };
  }),
    ...
    return function(e, n) {
      ...
      for (var s = 0; l > s; s++) {
        ...
        var U = u * u,
          g = u * U;
        o.push([
          t(h[0], V[0], d[0], c[0], u, U, g),
          t(h[1], V[1], d[1], c[1], u, U, g),
        ]);
      }
      return o;
    };
  ...
  define('echarts/util/ecQuery', ['require', 'zrender/tool/util'], function(e) {
    ...
    function n(e, i) {
      for (var n, o = e.length; o--; ) {
        var r = t(e[o], i);
        'undefined' != typeof r &&
          ('undefined' == typeof n ? (n = a.clone(r)) : a.merge(n, r, !0));
      }
      return n;
    }
  ...
  define('echarts/data/KDTree', ['require', './quickSelect'], function(e) {
    ...
    return (
      (n.prototype._buildTree = function(e, n, a, o) {
        if (n > a) return null;
        ...
        var s = e[r],
          l = new t(o, s);
        return (
          (o = (o + 1) % this.dimension),
          a > n &&
            ((l.left = this._buildTree(e, n, r - 1, o)),
      ...
      (n.prototype.nearest = function(e, t) {
        var i = this.root,
          ...
          r = null;
        for (
          i.data !== e && ((o = t(i.data, e)), (r = i)),
            e.array[i.axis] < i.data.array[i.axis]
              ? (i.right && (n[a++] = i.right), i.left && (n[a++] = i.left))
              : (i.left && (n[a++] = i.left), i.right && (n[a++] = i.right));
          a--;
          ...
          (s *= s),
            o > s &&
              ((s = t(i.data, e)),
              o > s && i.data !== e && ((o = s), (r = i)),
              (h = !0)),
            l
              ? (h && i.right && (n[a++] = i.right),
                i.left && (n[a++] = i.left))
              : (h && i.left && (n[a++] = i.left),
                i.right && (n[a++] = i.right));
        }
      ...
      (n.prototype._addNearest = function(e, t, i) {
        for (
          var n = this._nearstNList, a = e - 1;
          a > 0 && !(t >= n[a - 1].dist);
          a--
        )
          (n[a].dist = n[a - 1].dist), (n[a].node = n[a - 1].node);
      ...
      (n.prototype.nearestN = function(e, t, i, n) {
        ...
        for (
          ...
          s[l] || (s[l] = {}), (s[l].dist = 0), (s[l].node = null);
        var h = i(a.data, e),
          d = 0;
        for (
          a.data !== e && (d++, this._addNearest(d, h, a)),
            e.array[a.axis] < a.data.array[a.axis]
              ? (a.right && (o[r++] = a.right), a.left && (o[r++] = a.left))
              : (a.left && (o[r++] = a.left), a.right && (o[r++] = a.right));
          r--;
          ...
          (h *= h),
            (t > d || h < s[d - 1].dist) &&
              ...
              (t > d || h < s[d - 1].dist) &&
                a.data !== e &&
                (t > d && d++, this._addNearest(d, h, a)),
              (m = !0)),
            c
              ? (m && a.right && (o[r++] = a.right),
                a.left && (o[r++] = a.left))
              : (m && a.left && (o[r++] = a.left),
                a.right && (o[r++] = a.right));
        }
      ...
      (t.prototype = {
        ...
        show: function(e) {
          ...
          (this._buttonClose.onclick = function() {
            ...
            this.query(this.option, 'toolbox.feature.dataView.readOnly') === !1
        ...
        _optionToContent: function() {
          ...
          if (this.option.xAxis)
            for (
              ...
              if ('category' == (s[e].type || 'category')) {
                for (r = [], t = 0, i = s[e].data.length; i > t; t++)
          ...
          for (e = 0, a = d.length; a > e; e++) {
            for (r = [], t = 0, i = d[e].data.length; i > t; t++)
              (o = d[e].data[t]),
                (h =
                  d[e].type == n.CHART_TYPE_PIE || d[e].type == n.CHART_TYPE_MAP
                    ? (o.name || '-') + ':'
                    : ''),
                d[e].type == n.CHART_TYPE_SCATTER &&
                  (o = this.getDataFromOption(o).join(', ')),
        ...
        _save: function() {
          ...
          if ('function' != typeof e) {
            for (
              var t = this._textArea.value.split('\n'),
                i = [],
                a = 0,
                o = t.length;
              o > a;
              ...
              (t[a] = this._trim(t[a])), '' !== t[a] && i.push(t[a]);
          ...
          if (this.option.xAxis)
            for (
              ...
              if ('category' == (h[t].type || 'category')) {
                for (
                  s = e[d].split(','), i = 0, a = h[t].data.length;
                  a > i;
                  i++
                )
                  (l = this._trim(s[i] || '')),
                    (r = h[t].data[i]),
                    'undefined' != typeof h[t].data[i].value
                      ? (h[t].data[i].value = l)
                      : (h[t].data[i] = l);
                d++;
              }
          ...
          for (t = 0, o = c.length; o > t; t++)
            if ((d++, c[t].type == n.CHART_TYPE_SCATTER))
              for (var i = 0, a = c[t].data.length; a > i; i++)
                (s = e[d]),
                  (l = s.replace(' ', '').split(',')),
                  'undefined' != typeof c[t].data[i].value
                    ? (c[t].data[i].value = l)
                    : (c[t].data[i] = l),
                  d++;
            else {
  ...
  define('zrender/tool/computeBoundingBox', [
    ...
    function t(e, t, i) {
      if (0 !== e.length) {
        for (
          var n = e[0][0], a = e[0][0], o = e[0][1], r = e[0][1], s = 1;
          s < e.length;
          s++
        ) {
          var l = e[s];
    ...
    var a = e('./vector'),
      ...
      h = function(e, t, i, n, o, h, d, c) {
        if (Math.abs(n - o) >= 2 * Math.PI)
          return (
            (d[0] = e - i), (d[1] = t - i), (c[0] = e + i), void (c[1] = t + i)
          );
        if (
          ((r[0] = Math.cos(n) * i + e),
          (r[1] = Math.sin(n) * i + t),
    ...
    return (
      (t.prototype = {
            ...
            if (this.option.axisLine.onZero) {
              ...
              if (this.isHorizontal() && null != t)
                for (var n = 0, a = this.shapeList.length; a > n; n++)
                  'axisLine' === this.shapeList[n]._axisShape
                    ? ((this.shapeList[n].style.yStart = this.shapeList[
                        n
                      ].style.yEnd = this.subPixelOptimize(
                        t,
                        this.shapeList[n].stylelineWidth
                      )),
                      this.zr.modShape(this.shapeList[n].id))
                    : 'axisTick' === this.shapeList[n]._axisShape &&
                      ((i =
                        this.shapeList[n].style.yEnd -
                        this.shapeList[n].style.yStart),
              ...
              if (!this.isHorizontal() && null != e)
                for (var n = 0, a = this.shapeList.length; a > n; n++)
                  'axisLine' === this.shapeList[n]._axisShape
                    ? ((this.shapeList[n].style.xStart = this.shapeList[
                        n
                    ...
                    : 'axisTick' === this.shapeList[n]._axisShape &&
                      ((i =
                        this.shapeList[n].style.xEnd -
                        this.shapeList[n].style.xStart),
        ...
        reformOption: function(e) {
          if (
            ...
            (!e[0].position ||
              ...
              (e[0].position = 'bottom'),
              e.length > 1 &&
                (e[1].position = 'bottom' === e[0].position ? 'top' : 'bottom');
            for (var t = 0, i = e.length; i > t; t++)
            ...
            (!e[0].position ||
              ...
              (e[0].position = 'left'),
              e.length > 1 &&
                (e[1].position = 'left' === e[0].position ? 'right' : 'left');
            for (var t = 0, i = e.length; i > t; t++)
        ...
        refresh: function(t) {
          ...
          for (
            var n = e('./categoryAxis'),
              a = e('./valueAxis'),
              o = Math.max((i && i.length) || 0, this._axisList.length),
              r = 0;
            o > r;
            r++
          )
        ...
        refixAxisShape: function(e) {
          for (
            var t,
              i,
              n,
              o = e.xAxis._axisList.concat(e.yAxis ? e.yAxis._axisList : []),
              r = o.length;
            r--;

          )
            (n = o[r]),
              n.type == a.COMPONENT_TYPE_AXIS_VALUE &&
                n._min < 0 &&
                n._max >= 0 &&
                (n.isHorizontal() ? (t = n.getCoord(0)) : (i = n.getCoord(0)));
      ...
      (t.prototype = {
        ...
        _backupData: function() {
          ...
          for (
            ...
            (s = l[h[i]]),
              ...
              s.data &&
                this.getDataFromOption(s.data[0]) instanceof Array &&
                (s.type == r.CHART_TYPE_SCATTER ||
                  s.type == r.CHART_TYPE_LINE ||
                  s.type == r.CHART_TYPE_BAR) &&
                (this._backupScale(), this._calculScatterMap(h[i]));
        },
        ...
        _buildBackground: function() {
          ...
          var g = V - U,
            ...
            b = t / (i - (i > 1 ? 1 : 0)),
            _ = 1;
          'horizontal' == this.zoomOption.orient && 1 > y
            ? (_ = Math.floor((3 * i) / e))
          ...
          for (var l = 0, h = i; h > l; l += _)
            (m = this.getDataFromOption(u[l], 0)),
              ...
              f.push(
                'horizontal' == this.zoomOption.orient
                  ? [
                      this._location.x + y * l,
                      this._location.y +
                        t -
                        1 -
                        Math.round(((m - U) / g) * (t - 10)),
                    ]
                  : [
                      this._location.x +
                        1 +
                        Math.round(((m - U) / g) * (e - 10)),
                      this._location.y + b * (h - l - 1),
                    ]
              );

          'horizontal' == this.zoomOption.orient
            ? (f.push([this._location.x + e, this._location.y + t]),
              f.push([this._location.x, this._location.y + t]))
            : (f.push([this._location.x, this._location.y]),
              f.push([this._location.x, this._location.y + t])),
            this.shapeList.push(
              new a({
                zlevel: this.getZlevelBase(),
        ...
        _syncFillerShape: function() {
          ...
          'horizontal' == this.zoomOption.orient
            ? ((e = this._startShape.style.x),
              ...
              (this._zoom.start =
                ((Math.min(e, t) - this._location.x) / this._location.width) *
                100),
              (this._zoom.end =
            ...
            : ((e = this._startShape.style.y),
              ...
              (this._fillerShae.style.height =
                Math.abs(e - t) - this._handleSize),
              (this._zoom.start =
                ((this._location.y + this._location.height - Math.max(e, t)) /
                  this._location.height) *
                100),
              (this._zoom.end =
                ((this._location.y +
            ...
            for (var l in t)
              (o = t[l]),
                null != o &&
                  ...
                  this.option[s][l].type != r.CHART_TYPE_K
                    ? (this._setScale(),
                      (this.option[s][l].data = this._synScatterData(l, o)))
                    : (this.option[s][l].data = o.slice(i, n)));
          }
          this._isSilence ||
        ...
        _synScatterData: function(e, t) {
          ...
          'horizontal' == this.zoomOption.orient
            ? ((i = l.x.max - l.x.min),
              ...
              (r = (this._zoom.end2 / 100) * i + l.y.min))
            : ((i = l.x.max - l.x.min),
          ...
          var h;
          (h = l.x.dataMappingMethods) &&
            ((n = h.coord2Value(n)), (a = h.coord2Value(a))),
            (h = l.y.dataMappingMethods) &&
              ((o = h.coord2Value(o)), (r = h.coord2Value(r)));
        ...
        __ondrift: function(e, t, i) {
          ...
          if (
            ('horizontal' == this.zoomOption.orient
              ? e.style.x + t - n <= this._location.x
                ? (e.style.x = this._location.x + n)
                : e.style.x + t + e.style.width + n >=
                  this._location.x + this._location.width
                ? (e.style.x =
                    this._location.x + this._location.width - e.style.width - n)
                : (e.style.x += t)
              : e.style.y + i - n <= this._location.y
              ? (e.style.y = this._location.y + n)
              : e.style.y + i + e.style.height + n >=
                this._location.y + this._location.height
              ? (e.style.y =
                  this._location.y + this._location.height - e.style.height - n)
              : (e.style.y += i),
            'filler' == e._type
              ? this._syncHandleShape()
        ...
        rectZoom: function(e) {
          ...
          var t = this.component.grid.getArea(),
            i = { x: e.x, y: e.y, width: e.width, height: e.height };
          if (
          ...
          return (
            'horizontal' == this.zoomOption.orient
              ? ((n = this._zoom.end - this._zoom.start),
        ...
        syncBackupData: function(e) {
          for (
            ...
            (i = a[o].data || a[o].eventList),
              (t = n[o]
                ? Math.floor((this._zoom.start / 100) * n[o].length)
                : 0);
        ...
        getRealDataIndex: function(e, t) {
          ...
          return i[e]
            ? Math.floor((this._zoom.start / 100) * i[e].length) + t
            : -1;
        },
        resize: function() {
          this.clear(),
      ...
      (t.prototype = {
        ...
        _getReformedLabel: function(e) {
          var t = this.getDataFromOption(this.option.data[e]),
            i =
              this.option.data[e].formatter || this.option.axisLabel.formatter;
          return (
            i &&
              ('function' == typeof i
                ? (t = i.call(this.myChart, t))
                : 'string' == typeof i && (t = i.replace('{value}', t))),
            t
          );
        },
        _getInterval: function() {
        ...
        _buildAxisTick: function() {
          ...
          if (this.isHorizontal())
            for (
              ...
              (!l || l(V, t[V])) &&
                ((p = this.subPixelOptimize(
                  this.getCoordByIndex(V) + (V >= 0 ? c : 0),
                  s
                )),
                (e = {
                  _axisShape: 'axisTick',
        ...
        _buildAxisLabel: function() {
          ...
          if (this.isHorizontal()) {
            ...
            var V, U;
            'left' == this.option.position
              ? ((V = this.grid.getX() - l), (U = 'right'))
              : ((V = this.grid.getXend() + l), (U = 'left'));
            for (var u = 0; a > u; u += this._interval)
              (c && !c(u, i[u])) ||
                '' === this._getReformedLabel(u) ||
                ((t = s.merge(i[u].textStyle || {}, d)),
                (e = {
                  ...
                  style: {
                    ...
                    textAlign: t.align || U,
                    textBaseline:
                      t.baseline || (0 === u && '' !== this.option.name)
                        ? 'bottom'
                        : u == a - 1 && '' !== this.option.name
                        ? 'top'
                        : 'middle',
                  },
                }),
        ...
        _buildSplitLine: function() {
          ...
          if (
            ...
            for (
              var m, p = this.grid.getY(), u = this.grid.getYend(), V = 0;
              i > V;
              V += this._interval
            )
              (!h || h(V, t[V])) &&
                ((m = this.subPixelOptimize(this.getCoordByIndex(V) + c, r)),
                (e = {
                  zlevel: this.getZlevelBase(),
                  z: this.getZBase(),
                  hoverable: !1,
            ...
            for (
              var U, g = this.grid.getX(), f = this.grid.getXend(), V = 0;
              i > V;
              V += this._interval
            )
              (!h || h(V, t[V])) &&
                ((U = this.subPixelOptimize(this.getCoordByIndex(V) - c, r)),
                (e = {
                  zlevel: this.getZlevelBase(),
                  z: this.getZBase(),
                  hoverable: !1,
          ...
          if (n instanceof Array) {
            ...
            if (this.isHorizontal())
              for (
                ...
                (s && !s(u, t[u]) && r > u) ||
                  ((d =
                    r > u ? this.getCoordByIndex(u) + h : this.grid.getXend()),
                  (e = {
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
                    hoverable: !1,
              ...
              for (
                ...
                (s && !s(u, t[u]) && r > u) ||
                  ((V = r > u ? this.getCoordByIndex(u) - h : this.grid.getY()),
                  (e = {
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
                    hoverable: !1,
        ...
        getCoord: function(e) {
          for (
            var t = this.option.data,
              i = t.length,
              n = this.getGap(),
              a = this.option.boundaryGap ? n / 2 : 0,
              o = 0;
            i > o;
            o++
          ) {
      ...
      (t.prototype = {
        ...
        _buildAxisLabel: function() {
          ...
          if (this.isHorizontal()) {
            ...
            var c, m;
            'left' === this.option.position
              ? ((c = this.grid.getX() - o), (m = 'right'))
              : ((c = this.grid.getXend() + o), (m = 'left'));
            for (var d = 0; i > d; d++)
              (e = {
                zlevel: this.getZlevelBase(),
                z: this.getZBase() + 3,
        ...
        _buildSplitLine: function() {
          ...
          if (this.isHorizontal())
            for (
              var h, d = this.grid.getY(), c = this.grid.getYend(), m = 0;
              i > m;
              m++
            )
            ...
            for (
              var p, u = this.grid.getX(), V = this.grid.getXend(), m = 0;
              i > m;
              m++
            )
        ...
        _calculateValue: function() {
          if (isNaN(this.option.min - 0) || isNaN(this.option.max - 0)) {
            for (
              ...
              !(
                (this.series[a].type != r.CHART_TYPE_LINE &&
                  this.series[a].type != r.CHART_TYPE_BAR &&
                  this.series[a].type != r.CHART_TYPE_SCATTER &&
                  this.series[a].type != r.CHART_TYPE_K &&
                  this.series[a].type != r.CHART_TYPE_EVENTRIVER) ||
                (n && !n.isSelected(this.series[a].name)) ||
                ((e = this.series[a].xAxisIndex || 0),
                (t = this.series[a].yAxisIndex || 0),
                (this.option.xAxisIndex != e && this.option.yAxisIndex != t) ||
                  !this._calculSum(i, a))
              );
            var s;
            for (var a in i) {
            ...
            for (var a in i) {
              ...
              for (var l = 0, h = s.length; h > l; l++)
                isNaN(s[l]) ||
                  ((this._min = Math.min(this._min, s[l])),
                  (this._max = Math.max(this._max, s[l])));
            }
            var d =
                'log' !== this.option.type ? this.option.boundaryGap : [0, 0],
        ...
        _calculSum: function(e, t) {
          ...
          if (this.series[t].stack) {
            ...
            for (var h = 0, d = n.length; d > h; h++)
              (i = this.getDataFromOption(n[h])),
                this.series[t].type === r.CHART_TYPE_K
                  ? (e[a].push(i[0]),
                    e[a].push(i[1]),
                    e[a].push(i[2]),
                    e[a].push(i[3]))
                  ...
                  ? (-1 != this.option.xAxisIndex &&
                      e[a].push(
                        'time' != this.option.type ? i[0] : s.getNewDate(i[0])
                      ),
                    -1 != this.option.yAxisIndex &&
                      e[a].push(
                        'time' != this.option.type ? i[1] : s.getNewDate(i[1])
                      ))
                  : e[a].push(i);
          } else {
            n = this.series[t].data;
        ...
        _reformTimeValue: function() {
          ...
          switch (i) {
            ...
            default:
              72e5 >= n
                ? (a = (Math.floor(this._min / n) + 1) * n)
                : ((a = s.getNewDate(this._min - -n)),
                  a.setHours(6 * Math.round(a.getHours() / 6)),
                  a.setMinutes(0),
                  a.setSeconds(0));
          }
          for (
            a - this._min < n / 2 && (a -= -n), t = s.getNewDate(a), e *= 1.5;
            e-- >= 0 &&
            (('month' == i ||
              'quarter' == i ||
              'half-year' == i ||
            ...
            this._valueList.push(t), (t = s.getNewDate(t - -n));
            ...
            for (var i = 0, n = this._valueList.length; n > i; i++)
              'function' == typeof t
                ? this._valueLabel.push(
                    e
                      ? t.call(this.myChart, this._valueList[i], e)
                      : t.call(this.myChart, this._valueList[i])
                  )
                : 'string' == typeof t &&
                  this._valueLabel.push(
                    e
                      ? s.format(t, this._valueList[i])
                      : t.replace('{value}', this._valueList[i])
                  );
          else
            for (var i = 0, n = this._valueList.length; n > i; i++)
              this._valueLabel.push(
        ...
        getCoord: function(e) {
          this._dataMappingMethods &&
            (e = this._dataMappingMethods.value2Coord(e)),
            (e = e < this._min ? this._min : e),
            (e = e > this._max ? this._max : e);
          var t;
          return (t = this.isHorizontal()
            ? this.grid.getX() +
              ((e - this._min) / (this._max - this._min)) * this.grid.getWidth()
            : this.grid.getYend() -
              ...
              : ((e = e < this.grid.getY() ? this.grid.getY() : e),
                ...
                (t =
                  ...
                  ((e - this.grid.getY()) / this.grid.getHeight()) *
                    (this._max - this._min))),
            this._dataMappingMethods &&
              (t = this._dataMappingMethods.coord2Value(t)),
            t.toFixed(2) - 0
          );
        },
  ...
  define('echarts/util/smartSteps', [], function() {
    ...
    function a(e, i, n, a) {
      ...
      if (0 > a) {
        ...
        for (var V = u.length; V--; )
          (u[V] = u[V].toFixed(p)), 0 === +u[V] && (u[V] = '0');
      } else (e *= m), (i *= m), (c *= m);
      return (
        (_ = 0),
        (b = 0),
        (y = 0),
        { min: e, max: i, secs: n, step: c, fix: p, exp: a, pnts: u }
      );
    }
    function o(n, a, o) {
      (a = W(a % 10) || 2),
        0 > a &&
          (i(n)
            ? (a = ('' + S(n)).replace(/0+$/, '').length || 1)
            : ((n = n.toFixed(15).replace(/0+$/, '')),
    ...
    function d(e, i) {
      for (var n, a, o, r, s = [], h = _.length; h--; )
        (n = _[h]),
          ...
          (o = X(e.c / a) * a),
          (r = I(i.c / a) * a),
          (s[h] = { min: o, max: r, step: a, span: r - o });
      return (
        s.sort(function(e, t) {
          var i = e.span - t.span;
    ...
    function u(e, t, i) {
      ...
      return (
        x ? (t = e + n) : k ? (e = t - n) : ((e -= n), (t += n)), h(e, t, i)
      );
    }
    function V(e, t, i, n) {
      return (
    ...
    function f(e, t, i) {
      ...
      for (var g = n.length; g--; ) {
        ...
        (p[g] = [i, l, h, d].join()),
          (m[g] = { secs: i, step: l, delta: h, score: d });
      }
      return (
        m.sort(function(e, t) {
