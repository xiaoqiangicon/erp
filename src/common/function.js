 ...
 * 通用函数
 *
 * define(['common/function'], function(func) {
 *     // func.cloneObject(obj): 复制对象
 *     // func.cloneArray(arr): 复制数组
 *     // func.alert(title, callback):
 *     // func.confirm(title, content, confirmCallback, cancelCallback):
 *     // func.dialog(title, content):
 *     // func.prompt(title, callback):
 *     // func.addCloseWindowHint(): 添加关闭页面的提示
 *     // func.removeCloseWindowHint(): 移除关闭页面的提示
 * })
 *
 * Created by senntyou on 2017/2/21.
 */

define(['jquery', 'jquery-confirm'], function($) {
  var data = {};
