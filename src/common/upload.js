 ...
 * 通用上传便捷函数
 *
 * js: define(['common/upload', function(upload) {
 *     upload(el, done);
 *     upload(el, done, progress);
 *     upload(el, option, done);
 *     upload(el, option. done, progress);
...
define([
  'jquery',
  './function',
  '../../old-com/jquery-file-upload/js/jquery.fileupload-image',
  '../../old-com/jquery-file-upload/js/jquery.fileupload-validate',
  'lib/jquery.seeAjax',
], function($, commonFunc) {
  var env;
  var url;
