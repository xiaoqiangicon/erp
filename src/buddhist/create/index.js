  ...
  var View = Backbone.View.extend({
    ...
    generateRandomPrice: function(e) {
      ...
      if (uploadBox.hasClass('upload_wrap_change')) {
        ...
        if (self.locationBc === 0) {
          img.src = 'http://erptest.zizaihome.com/static/images/suixi.jpg';
        } else if (self.locationBc === 1) {
          img.src = 'http://erprelease.zizaihome.com/static/images/suixi.jpg';
        } else if (self.locationBc === 2) {
          img.src = 'http://erp.zizaihome.com/static/images/suixi.jpg';
        }
    ...
    click_get_feedback_item: function(e) {
      ...
      if ($tar.hasClass('selected_feedback_item')) {
        ...
        $(selected_img)
          .attr({ src: '/static/images/common/green_selected.png' })
