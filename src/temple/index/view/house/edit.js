...
$.seeView({
  ...
  changeDisplayType: function (e) {
    ...
    var value = parseInt($("[data-edit-com-house-display-type]:checked").attr("value"));
    var $displayComponents = $("[data-container=\"component-display\"][data-type=\"7\"][data-id=\"" + id + "\"]");
    if (value === 1) $displayComponents.removeClass("com-house-cell"); else $displayComponents.addClass("com-house-cell");
  },
