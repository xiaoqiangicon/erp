...
$.seeView({
  ...
  onKeyUpInDonateChartTitle: function (e) {
    var self = this, $this = $(e.target), id = parseInt($this.attr("data-donate-chart-title")), value = $this.val().trim();
    $("[data-donate-chart-title-display=\"" + id + "\"]").text(value);
  },
  onChangeInDonateChartItemsCount: function (e) {
    var self = this, $this = $(e.target), id = parseInt($this.attr("data-donate-chart-items-count")), count = parseInt($this.val()), $items = $("[data-donate-chart-items=\"" + id + "\"]");
  ...
  onChangeEditDonateChartType: function (e) {
    var self = this, $this = $(e.target), $realTimeCheckbox = $("[data-edit-donate-chart-type][data-index=\"1\"]"), realTimeActive = $realTimeCheckbox.prop("checked"), $monthCheckbox = $("[data-edit-donate-chart-type][data-index=\"2\"]"), monthActive = $monthCheckbox.prop("checked"), $totalCheckbox = $("[data-edit-donate-chart-type][data-index=\"3\"]"), totalActive = $totalCheckbox.prop("checked");
    if (!realTimeActive) {
