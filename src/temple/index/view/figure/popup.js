...
$.seeView({
  events: {
    ...
    "propertychange #edit-pop-figure-input-description": "changeInputDescription",
    ...
    if (!choose) {
      choose = new ChooseImage({
        ...
        onSubmit: function (data) {
          ...
          $addBox.before(figureTpl.avatarRow.render({
            image: data[0].src
          }));
  ...
  clickOk: function () {
    ...
    var formatImage = image.indexOf("?") < 0 ? image + indexData.imagesParams[2] : image;
