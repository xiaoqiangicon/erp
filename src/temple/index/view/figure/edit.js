...
$.seeView({
  ...
  changeDisplayType: function (e) {
    ...
    var value = parseInt($("[data-edit-com-figure-display-type]:checked").attr("value"));
    var $displayComponents = $("[data-container=\"component-display\"][data-type=\"2\"][data-id=\"" + id + "\"]");
    if (value === 1) $displayComponents.removeClass("com-figure-cell"); else $displayComponents.addClass("com-figure-cell");
  },
  ...
  clickRowEdit: function (e) {
    ...
    $("#edit-pop-figure-add-avatar-box").addClass("hide").before(figureTpl.avatarRow.render({
      image: com.avatar
    }));
