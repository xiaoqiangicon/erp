...
function postHandleForDonateChart($displayComponent, $editContainer, data) {
  var id = data.id, $items = $displayComponent.find("[data-donate-chart-items]");
  ...
  var $realTimeCheckbox = $("[data-edit-donate-chart-type][data-index=\"1\"]"), realTimeActive = data.showRealTimeList, $monthCheckbox = $("[data-edit-donate-chart-type][data-index=\"2\"]"), monthActive = data.showMonthList, $totalCheckbox = $("[data-edit-donate-chart-type][data-index=\"3\"]"), totalActive = data.showTotalList;
