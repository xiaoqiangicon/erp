...
function postHandleForIntroduction($displayComponent, $editContainer, data) {
  var id = data.id, $swiperWrapper = $displayComponent.find(".swiper-wrapper"), $uploadAdd = $editContainer.find("[data-file-upload-container]"), swiperWrapperInnerHtml = "";
  ...
  data.images.length >= indexData.misc.introductionUploadLimit && $uploadAdd.hide();
  ...
  $displayComponent.find("[data-introduction-place-display]").text(data.province + " " + data.city + (data.district ? " " + data.district : ""));
  data.introduction = data.introduction.replace(/<br>/g, "\n");
  $displayComponent.find("[data-introduction-introduction-display]").text(data.introduction);
  $editContainer.find("[data-introduction-introduction]").val(data.introduction);
  $editContainer.find("[data-input-count-display]").text(data.introduction.length);
