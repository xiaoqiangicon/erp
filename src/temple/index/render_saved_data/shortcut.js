...
function postHandleForShortcut($displayComponent, $editContainer, data) {
  var id = data.id, $editTitle = $editContainer.find("[data-edit-shortcut-title]"), $displayTitle = $displayComponent.find("[data-display-shortcut-title]"), $displayBody = $displayComponent.find("[data-display-shortcut-body]"), $addEl = $editContainer.find("[data-edit-shortcut-add]");
