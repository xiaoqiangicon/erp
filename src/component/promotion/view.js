...
seeView({
  ...
  onClickClose: function (e) {
    if (e.target === e.currentTarget) {
      let $this = $(e.target);
      if ($this.hasClass("zzh-promotion")) $this.remove(); else $this.parents(".zzh-promotion").remove();
      data.onClose && data.onClose();
    }
  },
  onClickTab2: function (e) {
    let $this = $(e.target), type = parseInt($this.attr("data-zzh-promotion-tab-2")), $qrcodeContainer = $("#zzh-promotion-qrcode-container");
    ...
    if (type === 2) $tabContainer.addClass("second"); else $tabContainer.removeClass("second");
  },
  onClickSaveQrCode: e => {
